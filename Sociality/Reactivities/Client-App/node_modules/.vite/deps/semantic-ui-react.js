  ...
  "node_modules/prop-types/factoryWithTypeCheckers.js"(exports2, module2) {
    ...
    module2.exports = function(isValidElement4, throwOnDirectAccess) {
      ...
      function createElementTypeTypeChecker() {
        function validate(props, propName, componentName, location, propFullName) {
          var propValue = props[propName];
          if (!ReactIs4.isValidElementType(propValue)) {
            var propType = getPropType(propValue);
...
var require_prop_types = __commonJS({
  "node_modules/prop-types/index.js"(exports2, module2) {
    if (true) {
      ReactIs4 = require_react_is();
      throwOnDirectAccess = true;
      module2.exports = require_factoryWithTypeCheckers()(ReactIs4.isElement, throwOnDirectAccess);
    } else {
      module2.exports = null();
    }
    var ReactIs4;
...
var require_event_stack_development = __commonJS({
  "node_modules/@semantic-ui-react/event-stack/lib/cjs/event-stack.development.js"(exports2) {
    ...
    var PropTypes163 = require_prop_types();
    var React184 = require_react();
    ...
    var isRefObject2 = function isRefObject3(ref2) {
      return ref2 !== null && _typeof2(ref2) === "object" && ref2.hasOwnProperty("current");
    };
    function normalizeTarget(target) {
      if (target === "document") return document;
      if (target === "window") return window;
      if (isRefObject2(target)) return target.current || document;
    ...
    EventStack$1.propTypes = {
      ...
      name: PropTypes163.string.isRequired,
      /** An event handler or array of event handlers. */
      on: PropTypes163.oneOfType([PropTypes163.func, PropTypes163.arrayOf(PropTypes163.func)]).isRequired,
      /** A name of pool. */
      pool: PropTypes163.string,
      /** A DOM element on which we will subscribe. */
      target: PropTypes163.oneOfType([
        PropTypes163.oneOf(["document", "window"]),
        // Heads up!
        // This condition for SSR safety.
        PropTypes163.instanceOf(env.canUseDOM ? HTMLElement : Object),
        PropTypes163.shape({
          current: PropTypes163.object
        })
      ])
    };
...
function createShorthand(Component3, mapValueToProps, val, options) {
  if (options === void 0) {
    options = {};
  }
  if (!ReactIs.isValidElementType(Component3)) {
  ...
  var valIsReactElement = React2.isValidElement(val);
  ...
  if (valIsReactElement) {
    return React2.cloneElement(val, props);
  }
  if (typeof props.children === "function") {
    return props.children(Component3, _extends({}, props, {
      children: void 0
    }));
  }
  ...
  if (valIsFunction) {
    if (true) {
      if (!DEPRECATED_CALLS[Component3]) {
        DEPRECATED_CALLS[Component3] = true;
        console.warn('Warning: There is a deprecated shorthand function usage for "' + Component3 + '". It is deprecated and will be removed in v3 release. Please follow our upgrade guide: https://github.com/Semantic-Org/Semantic-UI-React/pull/4029');
      }
    }
    return val(Component3, props, props.children);
  }
}
function createShorthandFactory(Component3, mapValueToProps) {
  if (!ReactIs.isValidElementType(Component3)) {
    throw new Error("createShorthandFactory(): Component should be a valid element type.");
  }
  return function(val, options) {
    return createShorthand(Component3, mapValueToProps, val, options);
  };
}
...
var getUnhandledProps = function getUnhandledProps2(Component3, props) {
  var _Component$handledPro = Component3.handledProps, handledProps = _Component$handledPro === void 0 ? [] : _Component$handledPro;
...
function getElementType(Component3, props, getDefault) {
  var _Component$defaultPro = Component3.defaultProps, defaultProps = _Component$defaultPro === void 0 ? {} : _Component$defaultPro;
...
// node_modules/semantic-ui-react/dist/es/lib/isRefObject.js
function isRefObject(ref2) {
  return ref2 !== null && typeof ref2 === "object" && ref2.hasOwnProperty("current");
}

// node_modules/semantic-ui-react/dist/es/lib/hooks/useAutoControlledValue.js
...
function useAutoControlledValue(options) {
  ...
  var _React$useState = React3.useState(initialState), internalState = _React$useState[0], setInternalState = _React$useState[1];
  var state = typeof options.state === "undefined" ? internalState : options.state;
  var stateRef = React3.useRef(state);
...
var useAutoControlledValue_default = useAutoControlledValue;
...
// node_modules/semantic-ui-react/dist/es/lib/hooks/useEventCallback.js
...
// node_modules/semantic-ui-react/dist/es/lib/hooks/useForceUpdate.js
var React7 = __toESM(require_react());
function useForceUpdate() {
  return React7.useReducer(function(x) {
    return x + 1;
  }, 0)[1];
}

// node_modules/semantic-ui-react/dist/es/lib/hooks/useMergedRefs.js
...
function useMergedRefs(refA, refB) {
  var mergedCallback = React8.useCallback(function(value) {
...
// node_modules/semantic-ui-react/dist/es/lib/hooks/usePrevious.js
var React9 = __toESM(require_react());
function usePrevious(value) {
  var ref2 = React9.useRef();
...
var IconGroup = import_react5.default.forwardRef(function(props, ref2) {
...
function getAriaProps(props) {
  var ariaOptions = {};
  var ariaLabel = props["aria-label"], ariaHidden = props["aria-hidden"];
...
var Icon = import_react6.default.forwardRef(function(props, ref2) {
  var bordered = props.bordered, circular = props.circular, className = props.className, color = props.color, corner = props.corner, disabled = props.disabled, fitted = props.fitted, flipped = props.flipped, inverted = props.inverted, link = props.link, loading = props.loading, name = props.name, rotated = props.rotated, size2 = props.size;
  ...
  var rest = getUnhandledProps_default(Icon, props);
  var ElementType = getElementType_default(Icon, props);
  ...
  var handleClick = useEventCallback(function(e) {
    ...
    invoke_default(props, "onClick", e, props);
  });
  return import_react6.default.createElement(ElementType, _extends({}, rest, ariaProps, {
    className: classes,
    onClick: handleClick,
    ref: ref2
  }));
...
var MemoIcon = import_react6.default.memo(Icon);
MemoIcon.Group = IconGroup_default;
...
// node_modules/semantic-ui-react/dist/es/addons/Portal/utils/useTrigger.js
...
function useTrigger(trigger, triggerRef) {
  var ref2 = useMergedRefs(trigger == null ? void 0 : trigger.ref, triggerRef);
  if (trigger) {
    if (true) {
      validateTrigger(trigger);
    }
    return [ref2, import_react8.default.cloneElement(trigger, {
      ref: ref2
    })];
  }
  return [ref2, null];
}
var useTrigger_default = useTrigger;
...
// node_modules/semantic-ui-react/dist/es/addons/Portal/usePortalElement.js
var import_react9 = __toESM(require_react());
var import_react_is = __toESM(require_react_is2());
function usePortalElement(node, userRef) {
  var ref2 = useMergedRefs(node.ref, userRef);
  if (import_react9.default.isValidElement(node)) {
    if (import_react_is.default.isForwardRef(node)) {
      return import_react9.default.cloneElement(node, {
        ref: ref2
      });
    }
...
// node_modules/semantic-ui-react/dist/es/addons/Portal/PortalInner.js
var PortalInner = import_react10.default.forwardRef(function(props, ref2) {
  var handleMount = useEventCallback(function() {
    return invoke_default(props, "onMount", null, props);
  });
  var handleUnmount = useEventCallback(function() {
    return invoke_default(props, "onUnmount", null, props);
  });
  var element = usePortalElement(props.children, ref2);
  ...
  return (0, import_react_dom.createPortal)(element, props.mountNode || document.body);
});
...
function Portal(props) {
  var children = props.children, closeOnDocumentClick = props.closeOnDocumentClick, closeOnEscape = props.closeOnEscape, closeOnPortalMouseLeave = props.closeOnPortalMouseLeave, closeOnTriggerBlur = props.closeOnTriggerBlur, closeOnTriggerClick = props.closeOnTriggerClick, closeOnTriggerMouseLeave = props.closeOnTriggerMouseLeave, eventPool = props.eventPool, mountNode = props.mountNode, mouseEnterDelay = props.mouseEnterDelay, mouseLeaveDelay = props.mouseLeaveDelay, openOnTriggerClick = props.openOnTriggerClick, openOnTriggerFocus = props.openOnTriggerFocus, openOnTriggerMouseEnter = props.openOnTriggerMouseEnter;
  var _useAutoControlledVal = useAutoControlledValue_default({
    state: props.open,
    defaultState: props.defaultOpen,
    initialState: false
  }), open = _useAutoControlledVal[0], setOpen = _useAutoControlledVal[1];
  var contentRef = import_react11.default.useRef();
  var _useTrigger = useTrigger_default(props.trigger, props.triggerRef), triggerRef = _useTrigger[0], trigger = _useTrigger[1];
  var mouseEnterTimer = import_react11.default.useRef();
  var mouseLeaveTimer = import_react11.default.useRef();
  var latestDocumentMouseDownEvent = import_react11.default.useRef();
  var openPortal = function openPortal2(e) {
    setOpen(true);
    invoke_default(props, "onOpen", e, _extends({}, props, {
      open: true
    }));
  };
  var openPortalWithTimeout = function openPortalWithTimeout2(e, delay) {
    var eventClone = _extends({}, e);
    return setTimeout(function() {
      return openPortal(eventClone);
    }, delay || 0);
  };
  var closePortal = function closePortal2(e) {
    setOpen(false);
    invoke_default(props, "onClose", e, _extends({}, props, {
      open: false
    }));
  };
  var closePortalWithTimeout = function closePortalWithTimeout2(e, delay) {
    var eventClone = _extends({}, e);
    return setTimeout(function() {
  ...
  var handleDocumentMouseDown = function handleDocumentMouseDown2(e) {
  ...
  var handleDocumentClick = function handleDocumentClick2(e) {
    ...
    var isInsideTrigger = doesNodeContainClick_default(triggerRef.current, e);
    var isOriginatedFromPortal = currentMouseDownEvent && doesNodeContainClick_default(contentRef.current, currentMouseDownEvent);
    var isInsidePortal = doesNodeContainClick_default(contentRef.current, e);
  ...
  var handlePortalMouseLeave = function handlePortalMouseLeave2(e) {
  ...
  var handlePortalMouseEnter = function handlePortalMouseEnter2() {
    if (!closeOnPortalMouseLeave) {
      return;
    }
    clearTimeout(mouseLeaveTimer.current);
  };
  var handleTriggerBlur = function handleTriggerBlur2(e) {
    ...
    var didFocusPortal = invoke_default(contentRef.current, "contains", target);
    if (!closeOnTriggerBlur || didFocusPortal) {
      return;
    }
    closePortal(e);
  };
  var handleTriggerClick = function handleTriggerClick2(e) {
  ...
  var handleTriggerFocus = function handleTriggerFocus2(e) {
  ...
  var handleTriggerMouseLeave = function handleTriggerMouseLeave2(e) {
  ...
  var handleTriggerMouseEnter = function handleTriggerMouseEnter2(e) {
  ...
  return import_react11.default.createElement(import_react11.default.Fragment, null, open && import_react11.default.createElement(import_react11.default.Fragment, null, import_react11.default.createElement(PortalInner_default, {
    mountNode,
    ...
    ref: contentRef
  }, children), import_react11.default.createElement(import_event_stack2.default, {
    name: "mouseleave",
    on: handlePortalMouseLeave,
    pool: eventPool,
    target: contentRef
  }), import_react11.default.createElement(import_event_stack2.default, {
    name: "mouseenter",
    ...
    on: handleEscape,
    pool: eventPool
  })), trigger && import_react11.default.cloneElement(trigger, {
...
var DimmerDimmable = import_react12.default.forwardRef(function(props, ref2) {
  ...
  return import_react12.default.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var DimmerInner = import_react13.default.forwardRef(function(props, ref2) {
  var active = props.active, children = props.children, className = props.className, content = props.content, disabled = props.disabled, inverted = props.inverted, page = props.page, simple = props.simple, verticalAlign = props.verticalAlign;
  var containerRef = useMergedRefs(ref2, import_react13.default.useRef());
  var contentRef = import_react13.default.useRef();
  useIsomorphicLayoutEffect_default(function() {
  ...
  var handleClick = function handleClick2(e) {
    invoke_default(props, "onClick", e, props);
    if (contentRef.current !== e.target && doesNodeContainClick_default(contentRef.current, e)) {
      return;
    }
    invoke_default(props, "onClickOutside", e, props);
  };
  ...
  var rest = getUnhandledProps_default(DimmerInner, props);
  var ElementType = getElementType_default(DimmerInner, props);
  ...
  return import_react13.default.createElement(ElementType, _extends({}, rest, {
    ...
    onClick: handleClick,
    ref: containerRef
  }), childrenContent && import_react13.default.createElement("div", {
    className: "content",
    ref: contentRef
  }, childrenContent));
});
...
var DimmerInner_default = DimmerInner;

// node_modules/semantic-ui-react/dist/es/modules/Dimmer/Dimmer.js
var Dimmer = import_react14.default.forwardRef(function(props, ref2) {
  var active = props.active, page = props.page;
  var rest = getUnhandledProps_default(Dimmer, props);
  if (page) {
    var handlePortalMount = function handlePortalMount2() {
      if (!isBrowser_default()) {
        return;
      }
    ...
    var handlePortalUnmount = function handlePortalUnmount2() {
      if (!isBrowser_default()) {
        return;
      }
    ...
    return import_react14.default.createElement(Portal_default, {
      closeOnEscape: false,
    ...
    }, import_react14.default.createElement(DimmerInner_default, _extends({}, rest, {
      active,
      page,
      ref: ref2
    })));
  }
  return import_react14.default.createElement(DimmerInner_default, _extends({}, rest, {
    active,
    page,
    ref: ref2
  }));
...
Dimmer.Inner = DimmerInner_default;
...
var ImageGroup = import_react15.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content, size2 = props.size;
...
// node_modules/semantic-ui-react/dist/es/elements/Image/Image.js
var Image = import_react16.default.forwardRef(function(props, ref2) {
  ...
  if (ElementType === "img") {
    return import_react16.default.createElement(ElementType, _extends({}, rootProps, imgTagProps, {
      className: classes,
      ref: ref2
    }));
  }
  return import_react16.default.createElement(ElementType, _extends({}, rootProps, {
    className: classes,
    href
  }), Dimmer_default.create(dimmer, {
    autoGenerateKey: false
  }), Label_default.create(label, {
    autoGenerateKey: false
  }), import_react16.default.createElement("img", _extends({}, imgTagProps, {
    ref: ref2
  })));
});
...
var LabelDetail = import_react17.default.forwardRef(function(props, ref2) {
...
var LabelGroup = import_react18.default.forwardRef(function(props, ref2) {
...
// node_modules/semantic-ui-react/dist/es/elements/Label/Label.js
var Label = import_react19.default.forwardRef(function(props, ref2) {
  var active = props.active, attached = props.attached, basic = props.basic, children = props.children, circular = props.circular, className = props.className, color = props.color, content = props.content, corner = props.corner, detail = props.detail, empty = props.empty, floating = props.floating, horizontal = props.horizontal, icon = props.icon, image = props.image, onRemove = props.onRemove, pointing = props.pointing, prompt = props.prompt, removeIcon = props.removeIcon, ribbon = props.ribbon, size2 = props.size, tag = props.tag;
  ...
  var rest = getUnhandledProps_default(Label, props);
  var ElementType = getElementType_default(Label, props);
  var handleClick = useEventCallback(function(e) {
    invoke_default(props, "onClick", e, props);
  });
  if (!childrenUtils_exports.isNil(children)) {
    ...
    overrideProps: function overrideProps(predefinedProps) {
      return {
        onClick: function onClick(e) {
          ...
          invoke_default(props, "onRemove", e, props);
        }
      };
    }
  }));
...
var ButtonContent = import_react20.default.forwardRef(function(props, ref2) {
...
var ButtonGroup = import_react21.default.forwardRef(function(props, ref2) {
...
var ButtonOr = import_react22.default.forwardRef(function(props, ref2) {
...
function hasIconClass(props) {
  var children = props.children, content = props.content, icon = props.icon, labelPosition = props.labelPosition;
  if (icon === true) {
    return true;
  }
  if (icon) {
    return labelPosition || childrenUtils_exports.isNil(children) && isNil_default(content);
  }
}
var Button = import_react23.default.forwardRef(function(props, ref2) {
  var active = props.active, animated = props.animated, attached = props.attached, basic = props.basic, children = props.children, circular = props.circular, className = props.className, color = props.color, compact2 = props.compact, content = props.content, disabled = props.disabled, floated = props.floated, fluid = props.fluid, icon = props.icon, inverted = props.inverted, label = props.label, labelPosition = props.labelPosition, loading = props.loading, negative = props.negative, positive = props.positive, primary = props.primary, secondary = props.secondary, size2 = props.size, toggle = props.toggle, type = props.type;
  var elementRef = useMergedRefs(ref2, import_react23.default.useRef());
  var baseClasses = clsx_m_default(color, size2, useKeyOnly(active, "active"), useKeyOnly(basic, "basic"), useKeyOnly(circular, "circular"), useKeyOnly(compact2, "compact"), useKeyOnly(fluid, "fluid"), useKeyOnly(hasIconClass(props), "icon"), useKeyOnly(inverted, "inverted"), useKeyOnly(loading, "loading"), useKeyOnly(negative, "negative"), useKeyOnly(positive, "positive"), useKeyOnly(primary, "primary"), useKeyOnly(secondary, "secondary"), useKeyOnly(toggle, "toggle"), useKeyOrValueAndKey(animated, "animated"), useKeyOrValueAndKey(attached, "attached"));
  ...
  var rest = getUnhandledProps_default(Button, props);
  var ElementType = getElementType_default(Button, props, function() {
  ...
  if (!isNil_default(label)) {
    ...
    var labelElement = Label_default.create(label, {
      defaultProps: {
        basic: true,
    ...
    return import_react23.default.createElement(ElementType, _extends({}, rest, {
      ...
      onClick: handleClick
    }), labelPosition === "left" && labelElement, import_react23.default.createElement("button", {
...
var ModalActions = import_react24.default.forwardRef(function(props, ref2) {
  var actions = props.actions, children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("actions", className);
  var rest = getUnhandledProps_default(ModalActions, props);
  var ElementType = getElementType_default(ModalActions, props);
  if (!childrenUtils_exports.isNil(children)) {
      ...
      overrideProps: function overrideProps(predefinedProps) {
        return {
          onClick: function onClick(e, buttonProps) {
            ...
            invoke_default(props, "onActionClick", e, buttonProps);
          }
        };
      }
    });
...
var ModalContent = import_react25.default.forwardRef(function(props, ref2) {
  ...
  return import_react25.default.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var ModalDescription = import_react26.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
...
var ModalDimmer = import_react27.default.forwardRef(function(props, ref2) {
  ...
  var elementRef = useMergedRefs(ref2, import_react27.default.useRef());
  ...
  return import_react27.default.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: elementRef
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var ModalHeader = import_react28.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  ...
  return import_react28.default.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
// node_modules/semantic-ui-react/dist/es/modules/Modal/Modal.js
var Modal = import_react29.default.forwardRef(function(props, ref2) {
  var actions = props.actions, basic = props.basic, centered = props.centered, children = props.children, className = props.className, closeIcon = props.closeIcon, closeOnDimmerClick = props.closeOnDimmerClick, closeOnDocumentClick = props.closeOnDocumentClick, content = props.content, dimmer = props.dimmer, eventPool = props.eventPool, header = props.header, size2 = props.size, style = props.style, trigger = props.trigger;
  var mountNode = isBrowser_default() ? props.mountNode || document.body : null;
  var _useAutoControlledVal = useAutoControlledValue_default({
    state: props.open,
    defaultState: props.defaultOpen,
    initialState: false
  }), open = _useAutoControlledVal[0], setOpen = _useAutoControlledVal[1];
  var _React$useState = import_react29.default.useState({}), legacyStyles = _React$useState[0], setLegacyStyles = _React$useState[1];
  var _React$useState2 = import_react29.default.useState(false), scrolling = _React$useState2[0], setScrolling = _React$useState2[1];
  var _React$useState3 = import_react29.default.useState(function() {
    return isBrowser_default() && isLegacy();
  }), legacy = _React$useState3[0];
  var elementRef = useMergedRefs(ref2, import_react29.default.useRef());
  var dimmerRef = import_react29.default.useRef();
  var animationRequestId = import_react29.default.useRef();
  var latestDocumentMouseDownEvent = import_react29.default.useRef();
  ...
  var setPositionAndClassNames = function setPositionAndClassNames2() {
    if (elementRef.current) {
      ...
      if (!(0, import_shallowequal.default)(computedLegacyStyles, computedLegacyStyles)) {
        setLegacyStyles(computedLegacyStyles);
      }
    }
    animationRequestId.current = requestAnimationFrame(setPositionAndClassNames2);
  };
  ...
  var handleDocumentClick = function handleDocumentClick2(e) {
    ...
    latestDocumentMouseDownEvent.current = null;
    if (!closeOnDimmerClick || doesNodeContainClick_default(elementRef.current, currentDocumentMouseDownEvent) || doesNodeContainClick_default(elementRef.current, e)) return;
    setOpen(false);
    invoke_default(props, "onClose", e, _extends({}, props, {
      open: false
    }));
  };
  var handleOpen = function handleOpen2(e) {
    setOpen(true);
    invoke_default(props, "onOpen", e, _extends({}, props, {
      open: true
    }));
  };
  var handlePortalMount = function handlePortalMount2(e) {
    setScrolling(false);
    setPositionAndClassNames();
    eventStack_default.sub("mousedown", handleDocumentMouseDown, {
      pool: eventPool,
      target: dimmerRef.current
    });
    eventStack_default.sub("click", handleDocumentClick, {
      pool: eventPool,
      target: dimmerRef.current
    });
    invoke_default(props, "onMount", e, props);
  };
  var handlePortalUnmount = function handlePortalUnmount2(e) {
    cancelAnimationFrame(animationRequestId.current);
    eventStack_default.unsub("mousedown", handleDocumentMouseDown, {
      pool: eventPool,
      target: dimmerRef.current
    });
    eventStack_default.unsub("click", handleDocumentClick, {
      pool: eventPool,
      target: dimmerRef.current
    });
    invoke_default(props, "onUnmount", e, props);
  };
  var renderContent = function renderContent2(rest2) {
    var classes = clsx_m_default("ui", size2, useKeyOnly(basic, "basic"), useKeyOnly(legacy, "legacy"), useKeyOnly(scrolling, "scrolling"), "modal transition visible active", className);
    var ElementType = getElementType_default(Modal, props);
    ...
    return import_react29.default.createElement(ElementType, _extends({}, rest2, {
      className: classes,
      ref: elementRef,
      style: _extends({}, legacyStyles, style)
    }), closeIconJSX, childrenUtils_exports.isNil(children) ? import_react29.default.createElement(import_react29.default.Fragment, null, ModalHeader_default.create(header, {
      autoGenerateKey: false
    }), ModalContent_default.create(content, {
      autoGenerateKey: false
    }), ModalActions_default.create(actions, {
      overrideProps: function overrideProps(predefinedProps) {
        return {
          onActionClick: function onActionClick(e, actionProps) {
            invoke_default(predefinedProps, "onActionClick", e, actionProps);
            invoke_default(props, "onActionClick", e, props);
            handleClose(e);
          }
        };
      }
  ...
  if (!isBrowser_default()) {
    return import_react29.default.isValidElement(trigger) ? trigger : null;
  }
  var unhandled = getUnhandledProps_default(Modal, props);
  ...
  return import_react29.default.createElement(Portal_default, _extends({
...
Modal.Actions = ModalActions_default;
...
// node_modules/semantic-ui-react/dist/es/addons/Confirm/Confirm.js
var Confirm = import_react30.default.forwardRef(function(props, ref2) {
  var cancelButton = props.cancelButton, confirmButton = props.confirmButton, content = props.content, header = props.header, open = props.open, size2 = props.size;
  var rest = getUnhandledProps_default(Confirm, props);
  var handleCancel = function handleCancel2(e) {
    invoke_default(props, "onCancel", e, props);
  };
  var handleCancelOverrides = function handleCancelOverrides2(predefinedProps) {
    return {
      onClick: function onClick(e, buttonProps) {
        invoke_default(predefinedProps, "onClick", e, buttonProps);
        handleCancel(e);
  ...
  var handleConfirmOverrides = function handleConfirmOverrides2(predefinedProps) {
    return {
      onClick: function onClick(e, buttonProps) {
        invoke_default(predefinedProps, "onClick", e, buttonProps);
        invoke_default(props, "onConfirm", e, props);
      }
    };
  };
  var openProp = {};
  if (has_default(props, "open")) {
    openProp.open = open;
  }
  return import_react30.default.createElement(Modal_default, _extends({}, rest, openProp, {
    size: size2,
    ...
    autoGenerateKey: false
  }), import_react30.default.createElement(Modal_default.Actions, null, Button_default.create(cancelButton, {
    autoGenerateKey: false,
...
var MenuHeader = import_react31.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("header", className);
...
var MenuItem = import_react32.default.forwardRef(function(props, ref2) {
  var active = props.active, children = props.children, className = props.className, color = props.color, content = props.content, disabled = props.disabled, fitted = props.fitted, header = props.header, icon = props.icon, link = props.link, name = props.name, onClick = props.onClick, position = props.position;
  ...
  var ElementType = getElementType_default(MenuItem, props, function() {
    if (onClick) return "a";
  });
  var rest = getUnhandledProps_default(MenuItem, props);
  var handleClick = useEventCallback(function(e) {
    if (!disabled) {
      invoke_default(props, "onClick", e, props);
    }
...
var MenuMenu = import_react33.default.forwardRef(function(props, ref2) {
  ...
  return import_react33.default.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
// node_modules/semantic-ui-react/dist/es/collections/Menu/Menu.js
var Menu = import_react34.default.forwardRef(function(props, ref2) {
  var attached = props.attached, borderless = props.borderless, children = props.children, className = props.className, color = props.color, compact2 = props.compact, fixed = props.fixed, floated = props.floated, fluid = props.fluid, icon = props.icon, inverted = props.inverted, items = props.items, pagination = props.pagination, pointing = props.pointing, secondary = props.secondary, size2 = props.size, stackable = props.stackable, tabular = props.tabular, text = props.text, vertical = props.vertical, widths = props.widths;
  var _useAutoControlledVal = useAutoControlledValue_default({
    state: props.activeIndex,
    defaultState: props.defaultActiveIndex,
    initialState: -1
  }), activeIndex = _useAutoControlledVal[0], setActiveIndex = _useAutoControlledVal[1];
  ...
  var rest = getUnhandledProps_default(Menu, props);
  var ElementType = getElementType_default(Menu, props);
  if (!childrenUtils_exports.isNil(children)) {
    return import_react34.default.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
  return import_react34.default.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), map_default(items, function(item, index) {
    return MenuItem_default.create(item, {
      defaultProps: {
      ...
      overrideProps: function overrideProps(predefinedProps) {
        return {
          onClick: function onClick(e, itemProps) {
            ...
            invoke_default(props, "onItemClick", e, itemProps);
          }
        };
      }
    });
...
var PaginationItem = React40.forwardRef(function(props, ref2) {
  var active = props.active, type = props.type;
  var disabled = props.disabled || type === "ellipsisItem";
  var handleClick = function handleClick2(e) {
    invoke_default(props, "onClick", e, props);
  };
  var handleKeyDown = function handleKeyDown2(e) {
    invoke_default(props, "onKeyDown", e, props);
    if (import_keyboard_key2.default.getCode(e) === import_keyboard_key2.default.Enter) {
      invoke_default(props, "onClick", e, props);
    }
  };
  return MenuItem_default.create(props, {
    defaultProps: {
      active,
      "aria-current": active,
...
// node_modules/semantic-ui-react/dist/es/addons/Pagination/Pagination.js
var Pagination = import_react35.default.forwardRef(function(props, ref2) {
  var ariaLabel = props["aria-label"], boundaryRange = props.boundaryRange, disabled = props.disabled, ellipsisItem = props.ellipsisItem, siblingRange = props.siblingRange, totalPages = props.totalPages;
  var _useAutoControlledVal = useAutoControlledValue_default({
    state: props.activePage,
    defaultState: props.defaultActivePage,
    initialState: 1
  }), activePage = _useAutoControlledVal[0], setActivePage = _useAutoControlledVal[1];
  var handleItemClick = function handleItemClick2(e, _ref) {
    ...
    invoke_default(props, "onPageChange", e, _extends({}, props, {
      activePage: nextActivePage
    }));
  };
  var handleItemOverrides = function handleItemOverrides2(active, type, value) {
  ...
  var rest = getUnhandledProps_default(Pagination, props);
  return import_react35.default.createElement(Menu_default, _extends({}, rest, {
    ...
    return PaginationItem_default.create(props[type], {
      defaultProps: {
        content: value,
        disabled,
        value
...
var Checkbox = import_react36.default.forwardRef(function(props, ref2) {
  var className = props.className, disabled = props.disabled, label = props.label, id = props.id, name = props.name, radio = props.radio, readOnly = props.readOnly, slider = props.slider, tabIndex = props.tabIndex, toggle = props.toggle, type = props.type, value = props.value;
  var _useAutoControlledVal = useAutoControlledValue_default({
    state: props.checked,
    defaultState: props.defaultChecked,
    initialState: false
  }), checked = _useAutoControlledVal[0], setChecked = _useAutoControlledVal[1];
  var _useAutoControlledVal2 = useAutoControlledValue_default({
    state: props.indeterminate,
    defaultState: props.defaultIndeterminate,
    initialState: false
  }), indeterminate = _useAutoControlledVal2[0], setIndeterminate = _useAutoControlledVal2[1];
  var inputRef = useMergedRefs(import_react36.default.useRef(), ref2);
  var labelRef = import_react36.default.useRef();
  var isClickFromMouse = import_react36.default.useRef();
  useIsomorphicLayoutEffect_default(function() {
    if (inputRef.current) {
      inputRef.current.indeterminate = !!indeterminate;
    }
  });
  var canToggle = function canToggle2() {
    return !disabled && !readOnly && !(radio && checked);
  };
  var computeTabIndex2 = function computeTabIndex3() {
    if (!isNil_default(tabIndex)) {
      return tabIndex;
    }
    return disabled ? -1 : 0;
  ...
  var handleChange = function handleChange2(e) {
    ...
    invoke_default(props, "onChange", e, _extends({}, props, {
      checked: !checked,
      indeterminate: false
    }));
    setChecked(!checked);
  ...
  var handleClick = function handleClick2(e) {
    var isInputClick = invoke_default(inputRef.current, "contains", e.target);
    var isLabelClick = invoke_default(labelRef.current, "contains", e.target);
    ...
    if (!isLabelClickAndForwardedToInput) {
      invoke_default(props, "onClick", e, _extends({}, props, {
        checked: !checked,
  ...
  var handleMouseDown = function handleMouseDown2(e) {
    invoke_default(props, "onMouseDown", e, _extends({}, props, {
      checked: !!checked,
      indeterminate: !!indeterminate
    }));
    if (!e.defaultPrevented) {
      invoke_default(inputRef.current, "focus");
    }
    e.preventDefault();
  };
  var handleMouseUp = function handleMouseUp2(e) {
    isClickFromMouse.current = true;
    invoke_default(props, "onMouseUp", e, _extends({}, props, {
      checked: !!checked,
      indeterminate: !!indeterminate
    }));
  };
  ...
  var unhandled = getUnhandledProps_default(Checkbox, props);
  var ElementType = getElementType_default(Checkbox, props);
  ...
  return import_react36.default.createElement(ElementType, _extends({}, rest, {
    className: classes,
    onClick: handleClick,
    onChange: handleChange,
    onMouseDown: handleMouseDown,
    onMouseUp: handleMouseUp
  }), import_react36.default.createElement("input", _extends({}, htmlInputProps2, {
    checked,
    className: "hidden",
    disabled,
    id,
    ...
    readOnly: true,
    ref: inputRef,
    tabIndex: computeTabIndex2(),
    type,
    value
  })), import_react36.default.cloneElement(labelElement, {
    ref: labelRef
  }));
});
...
// node_modules/semantic-ui-react/dist/es/addons/Radio/Radio.js
var Radio = import_react37.default.forwardRef(function(props, ref2) {
  ...
  return import_react37.default.createElement(Checkbox_default, _extends({}, rest, {
    type,
    radio,
    slider,
    toggle,
...
Radio.propTypes = true ? {
  /** Format to emphasize the current selection state. */
  slider: Checkbox_default.propTypes.slider,
  /** Format to show an on or off choice. */
  toggle: Checkbox_default.propTypes.toggle,
  /** HTML input type, either checkbox or radio. */
  type: Checkbox_default.propTypes.type
} : {};
Radio.defaultProps = {
  type: "radio"
};
...
var Flag = import_react38.default.forwardRef(function(props, ref2) {
  var className = props.className, name = props.name;
  var classes = clsx_m_default(name, "flag", className);
  var rest = getUnhandledProps_default(Flag, props);
  var ElementType = getElementType_default(Flag, props);
...
var MemoFlag = import_react38.default.memo(Flag);
...
var Flag_default = MemoFlag;

// node_modules/semantic-ui-react/dist/es/modules/Dropdown/DropdownDivider.js
var import_prop_types33 = __toESM(require_prop_types());
var import_react39 = __toESM(require_react());
var DropdownDivider = import_react39.default.forwardRef(function(props, ref2) {
  ...
  return import_react39.default.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }));
});
...
var DropdownItem = import_react40.default.forwardRef(function(props, ref2) {
  var active = props.active, children = props.children, className = props.className, content = props.content, disabled = props.disabled, description = props.description, flag = props.flag, icon = props.icon, image = props.image, label = props.label, selected = props.selected, text = props.text;
  var handleClick = function handleClick2(e) {
    invoke_default(props, "onClick", e, props);
  };
  ...
  var rest = getUnhandledProps_default(DropdownItem, props);
  var ElementType = getElementType_default(DropdownItem, props);
  var ariaOptions = {
    role: "option",
    "aria-disabled": disabled,
    "aria-checked": active,
  ...
  if (!childrenUtils_exports.isNil(children)) {
    return import_react40.default.createElement(ElementType, _extends({}, rest, ariaOptions, {
      className: classes,
      onClick: handleClick,
      ref: ref2
    }), children);
...
var DropdownHeader = import_react41.default.forwardRef(function(props, ref2) {
...
var DropdownMenu = import_react42.default.forwardRef(function(props, ref2) {
  ...
  return import_react42.default.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var DropdownSearchInput = import_react43.default.forwardRef(function(props, ref2) {
  var autoComplete = props.autoComplete, className = props.className, tabIndex = props.tabIndex, type = props.type, value = props.value;
  var handleChange = function handleChange2(e) {
    var newValue = get_default(e, "target.value");
    invoke_default(props, "onChange", e, _extends({}, props, {
      value: newValue
    }));
  };
  var classes = clsx_m_default("search", className);
  var ElementType = getElementType_default(DropdownSearchInput, props);
  var rest = getUnhandledProps_default(DropdownSearchInput, props);
...
var DropdownText = import_react44.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("divider", className);
  var rest = getUnhandledProps_default(DropdownText, props);
  var ElementType = getElementType_default(DropdownText, props);
  return import_react44.default.createElement(ElementType, _extends({
    "aria-atomic": true,
    "aria-live": "polite",
    role: "alert"
  }, rest, {
...
function getMenuOptions(config) {
  ...
  if (allowAdditions && search && searchQuery && !some_default(filteredOptions, {
    ...
    var additionLabelElement = import_react45.default.isValidElement(additionLabel) ? import_react45.default.cloneElement(additionLabel, {
      key: "addition-label"
    }) : additionLabel || "";
    var addItem = {
      key: "addition",
      ...
      text: [additionLabelElement, import_react45.default.createElement("b", {
        key: "addition-query"
      }, searchQuery)],
      value: searchQuery,
      className: "addition",
...
function renderItemContent(item) {
  ...
  return {
    content: import_react46.default.createElement(import_react46.default.Fragment, null, Flag_default.create(flag), Image_default.create(image), text)
  };
}
var Dropdown = import_react46.default.forwardRef(function(props, ref2) {
  return import_react46.default.createElement(DropdownInner, _extends({}, props, {
    innerRef: ref2
  }));
});
...
var DropdownInner = function(_Component) {
  _inheritsLoose(DropdownInner2, _Component);
  function DropdownInner2() {
    var _this;
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _Component.call.apply(_Component, [this].concat(args)) || this;
    _this.searchRef = (0, import_react46.createRef)();
    _this.sizerRef = (0, import_react46.createRef)();
    _this.ref = (0, import_react46.createRef)();
    ...
    _this.renderSearchInput = function() {
      ...
      var searchQuery = _this.state.searchQuery;
      return search && DropdownSearchInput_default.create(searchInput, {
        defaultProps: {
          style: {
    ...
    _this.renderSearchSizer = function() {
      ...
      return search && multiple && import_react46.default.createElement("span", {
        className: "sizer",
        ref: _this.sizerRef
      });
    };
    _this.renderLabels = function() {
      ...
      return map_default(compact_default(selectedItems), function(item, index) {
        ...
        return Label_default.create(renderLabel(item, index, defaultProps), {
          defaultProps
        });
      });
    };
    ...
    _this.renderMenu = function() {
      ...
      if (!childrenUtils_exports.isNil(children)) {
        var menuChild = import_react46.Children.only(children);
        var className = clsx_m_default(direction, useKeyOnly(open, "visible"), menuChild.props.className);
        return (0, import_react46.cloneElement)(menuChild, _extends({
          className
        }, ariaOptions));
      }
      return import_react46.default.createElement(DropdownMenu_default, _extends({}, ariaOptions, {
        direction,
        open
  ...
  var _proto = DropdownInner2.prototype;
  ...
  DropdownInner2.getAutoControlledStateFromProps = function getAutoControlledStateFromProps(nextProps, computedState, prevState) {
    var derivedState = {
  ...
  _proto.render = function render() {
    ...
    var rest = getUnhandledProps_default(Dropdown, this.props);
    var ElementType = getElementType_default(Dropdown, this.props);
    var ariaOptions = this.getDropdownAriaOptions(ElementType, this.props);
    return import_react46.default.createElement(ElementType, _extends({}, rest, ariaOptions, {
      className: classes,
      ...
      autoGenerateKey: false
    }), this.renderMenu(), open && import_react46.default.createElement(import_event_stack3.default, {
      name: "keydown",
      on: this.closeOnEscape
    }), open && import_react46.default.createElement(import_event_stack3.default, {
      name: "click",
      on: this.closeOnDocumentClick
    }), focus && import_react46.default.createElement(import_event_stack3.default, {
      name: "keydown",
      on: this.removeItemOnBackspace
    }));
  };
  return DropdownInner2;
...
if (true) {
  ...
  DropdownInner.propTypes = true ? Dropdown.propTypes : {};
}
...
// node_modules/semantic-ui-react/dist/es/addons/Select/Select.js
var Select = import_react47.default.forwardRef(function(props, ref2) {
  return import_react47.default.createElement(Dropdown_default, _extends({}, props, {
    selection: true,
    ref: ref2
  }));
});
...
Select.propTypes = true ? {
  /** Array of Dropdown.Item props e.g. `{ text: '', value: '' }` */
  options: import_prop_types40.default.arrayOf(import_prop_types40.default.shape(Dropdown_default.Item.propTypes)).isRequired
} : {};
Select.Divider = Dropdown_default.Divider;
Select.Header = Dropdown_default.Header;
Select.Item = Dropdown_default.Item;
Select.Menu = Dropdown_default.Menu;
var Select_default = Select;

// node_modules/semantic-ui-react/dist/es/addons/TextArea/TextArea.js
var import_prop_types41 = __toESM(require_prop_types());
var import_react48 = __toESM(require_react());
var TextArea = import_react48.default.forwardRef(function(props, ref2) {
  var rows = props.rows, value = props.value;
  var elementRef = useMergedRefs(ref2, import_react48.default.useRef());
  var handleChange = function handleChange2(e) {
    var newValue = get_default(e, "target.value");
    invoke_default(props, "onChange", e, _extends({}, props, {
      value: newValue
  ...
  var handleInput = function handleInput2(e) {
    var newValue = get_default(e, "target.value");
    invoke_default(props, "onInput", e, _extends({}, props, {
      value: newValue
    }));
  };
  var rest = getUnhandledProps_default(TextArea, props);
  var ElementType = getElementType_default(TextArea, props);
  return import_react48.default.createElement(ElementType, _extends({}, rest, {
    onChange: handleChange,
    onInput: handleInput,
    ref: elementRef,
    rows,
...
var getChildMapping = function getChildMapping2(children) {
  return keyBy_default(filter_default(import_react49.Children.toArray(children), import_react49.isValidElement), "key");
};
...
function wrapChild(child, onHide, options) {
  ...
  return import_react50.default.createElement(Transition, {
    animation,
    directional,
    duration,
    key,
...
function useWrappedChildren(children, animation, duration, directional) {
  ...
  var previousChildren = import_react51.default.useRef();
  var wrappedChildren;
  ...
  if (typeof previousChildren.current === "undefined") {
    wrappedChildren = mapValues_default(getChildMapping(children), function(child) {
    ...
    forEach_default(wrappedChildren, function(child, key) {
      ...
      if (!hasNext && hasPrev && !isLeaving) {
        wrappedChildren[key] = import_react51.default.cloneElement(prevChild, {
          visible: false
        });
        return;
      }
...
var TransitionGroup = import_react51.default.forwardRef(function(props, ref2) {
  var children = useWrappedChildren(props.children, props.animation, props.duration, props.directional);
  var ElementType = getElementType_default(TransitionGroup, props);
  var rest = getUnhandledProps_default(TransitionGroup, props);
  return import_react51.default.createElement(ElementType, _extends({}, rest, {
    ref: ref2
  }), values_default(children));
});
...
TransitionGroup.defaultProps = {
  as: import_react51.default.Fragment,
  animation: "fade",
  duration: 500
};
...
var Transition = function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    var _this$state2 = this.state, nextStatus = _this$state2.nextStatus, status = _this$state2.status;
    if (status === TRANSITION_STATUS_UNMOUNTED) {
      return null;
    }
...
Transition.Group = TransitionGroup_default;
...
function usePortalState(props) {
  var portalOpen = import_react52.default.useRef(false);
  var forceUpdate = useForceUpdate();
  var setPortalOpen = import_react52.default.useCallback(function(value) {
    portalOpen.current = value;
    forceUpdate();
  }, []);
  import_react52.default.useEffect(function() {
...
function TransitionablePortal(props) {
  var children = props.children, transition = props.transition;
  var _usePortalState = usePortalState(props), portalOpen = _usePortalState[0], setPortalOpen = _usePortalState[1];
  var _React$useState = import_react52.default.useState(false), transitionVisible = _React$useState[0], setTransitionVisible = _React$useState[1];
  var open = portalOpen || transitionVisible;
  var handlePortalClose = function handlePortalClose2() {
    setPortalOpen(-1);
  };
  var handlePortalOpen = function handlePortalOpen2() {
    setPortalOpen(true);
  };
  var handleTransitionHide = function handleTransitionHide2(nothing, data) {
    setTransitionVisible(false);
    invoke_default(props, "onClose", null, _extends({}, data, {
      portalOpen: false,
      transitionVisible: false
    }));
    invoke_default(props, "onHide", null, _extends({}, data, {
      portalOpen,
      transitionVisible: false
    }));
  };
  var handleTransitionStart = function handleTransitionStart2(nothing, data) {
    var status = data.status;
    var nextTransitionVisible = status === TRANSITION_STATUS_ENTERING;
    invoke_default(props, "onStart", null, _extends({}, data, {
      portalOpen,
    ...
    invoke_default(props, "onOpen", null, _extends({}, data, {
      transitionVisible: nextTransitionVisible,
      portalOpen: true
    }));
  };
  var rest = getUnhandledProps_default(TransitionablePortal, props);
...
var TransitionablePortal_default = TransitionablePortal;
...
var BreadcrumbDivider = import_react53.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content, icon = props.icon;
  var classes = clsx_m_default("divider", className);
  ...
  if (!isNil_default(content)) {
    return import_react53.default.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), content);
  }
...
var BreadcrumbSection = import_react54.default.forwardRef(function(props, ref2) {
  var active = props.active, children = props.children, className = props.className, content = props.content, href = props.href, link = props.link, onClick = props.onClick;
  var classes = clsx_m_default(useKeyOnly(active, "active"), "section", className);
  var rest = getUnhandledProps_default(BreadcrumbSection, props);
  var ElementType = getElementType_default(BreadcrumbSection, props, function() {
    if (link || onClick) return "a";
  });
  var handleClick = useEventCallback(function(e) {
    return invoke_default(props, "onClick", e, props);
  });
...
BreadcrumbSection.propTypes = true ? {
  ...
  href: customPropTypes_exports.every([customPropTypes_exports.disallow(["link"]), import_prop_types46.default.string]),
  /** Render as an `a` tag instead of a `div`. */
  link: customPropTypes_exports.every([customPropTypes_exports.disallow(["href"]), import_prop_types46.default.bool]),
  /**
   * Called on click. When passed, the component will render as an `a`
   * tag by default instead of a `div`.
   *
...
var BreadcrumbSection_default = BreadcrumbSection;

// node_modules/semantic-ui-react/dist/es/collections/Breadcrumb/Breadcrumb.js
var Breadcrumb = import_react55.default.forwardRef(function(props, ref2) {
  ...
  forEach_default(sections, function(section, index) {
    var breadcrumbElement = BreadcrumbSection_default.create(section);
...
Breadcrumb.propTypes = true ? {
  ...
  /** Size of Breadcrumb. */
  size: import_prop_types47.default.oneOf(without_default(SUI_exports.SIZES, "medium"))
} : {};
Breadcrumb.Divider = BreadcrumbDivider_default;
Breadcrumb.Section = BreadcrumbSection_default;
...
var FormField = import_react56.default.forwardRef(function(props, ref2) {
  ...
  var errorLabel = Label_default.create(error, {
    autoGenerateKey: false,
    defaultProps: {
      prompt: true,
  ...
  if (control === "input" && (type === "checkbox" || type === "radio")) {
    return import_react56.default.createElement(ElementType, {
      className: classes
    }, import_react56.default.createElement("label", null, errorLabelBefore, (0, import_react56.createElement)(control, _extends({}, ariaAttrs, controlProps)), " ", label, errorLabelAfter));
  }
  if (control === Checkbox_default || control === Radio_default) {
    return import_react56.default.createElement(ElementType, {
      className: classes
    }, errorLabelBefore, (0, import_react56.createElement)(control, _extends({}, ariaAttrs, controlProps, {
      label
    })), errorLabelAfter);
  }
  return import_react56.default.createElement(ElementType, {
    ...
    autoGenerateKey: false
  }), errorLabelBefore, (0, import_react56.createElement)(control, _extends({}, ariaAttrs, controlProps)), errorLabelAfter);
});
...
FormField.propTypes = true ? {
   ...
   */
  control: import_prop_types48.default.oneOfType([import_prop_types48.default.elementType, import_prop_types48.default.oneOf(["button", "input", "select", "textarea"])]),
  /** Individual fields may be disabled. */
  disabled: import_prop_types48.default.bool,
  /** Individual fields may display an error state along with a message. */
  error: import_prop_types48.default.oneOfType([import_prop_types48.default.bool, customPropTypes_exports.itemShorthand]),
  /** The id of the control */
  id: import_prop_types48.default.string,
  /** A field can have its label next to instead of above it. */
  inline: import_prop_types48.default.bool,
  // Heads Up!
  // Do not disallow children with `label` shorthand
  // The `control` might accept a `label` prop and `children`
  /** Mutually exclusive with children. */
  label: import_prop_types48.default.oneOfType([import_prop_types48.default.node, import_prop_types48.default.object]),
  ...
  width: import_prop_types48.default.oneOf(SUI_exports.WIDTHS)
} : {};
var FormField_default = FormField;

// node_modules/semantic-ui-react/dist/es/collections/Form/FormButton.js
var FormButton = import_react57.default.forwardRef(function(props, ref2) {
...
var FormCheckbox = import_react58.default.forwardRef(function(props, ref2) {
  var control = props.control;
...
var FormDropdown = import_react59.default.forwardRef(function(props, ref2) {
  var control = props.control;
...
var FormGroup = import_react60.default.forwardRef(function(props, ref2) {
...
FormGroup.propTypes = true ? {
  ...
  grouped: customPropTypes_exports.every([customPropTypes_exports.disallow(["inline"]), import_prop_types52.default.bool]),
  /** Multiple fields may be inline in a row. */
  inline: customPropTypes_exports.every([customPropTypes_exports.disallow(["grouped"]), import_prop_types52.default.bool]),
  /** A form group can prevent itself from stacking on mobile. */
  unstackable: import_prop_types52.default.bool,
  /** Fields Groups can specify their width in grid columns or automatically divide fields to be equal width. */
  widths: import_prop_types52.default.oneOf([].concat(SUI_exports.WIDTHS, ["equal"]))
} : {};
...
var Input = import_react61.default.forwardRef(function(props, _ref) {
  var action = props.action, actionPosition = props.actionPosition, children = props.children, className = props.className, disabled = props.disabled, error = props.error, fluid = props.fluid, focus = props.focus, icon = props.icon, iconPosition = props.iconPosition, input = props.input, inverted = props.inverted, label = props.label, labelPosition = props.labelPosition, loading = props.loading, size2 = props.size, tabIndex = props.tabIndex, transparent = props.transparent, type = props.type;
  var computeIcon = function computeIcon2() {
    if (!isNil_default(icon)) {
      return icon;
    }
    if (loading) {
  ...
  var partitionProps = function partitionProps2() {
    var unhandledProps = getUnhandledProps_default(Input, props);
    var _partitionHTMLProps = partitionHTMLProps(unhandledProps), htmlInputProps3 = _partitionHTMLProps[0], rest2 = _partitionHTMLProps[1];
    return [_extends({}, htmlInputProps3, {
      disabled,
      type,
      tabIndex: computeTabIndex2(),
      onChange: handleChange,
  ...
  var ElementType = getElementType_default(Input, props);
  var _partitionProps = partitionProps(), htmlInputProps2 = _partitionProps[0], rest = _partitionProps[1];
  if (!childrenUtils_exports.isNil(children)) {
    var childElements = map_default(import_react61.default.Children.toArray(children), function(child) {
      if (child.type === "input") {
        return import_react61.default.cloneElement(child, _extends({}, htmlInputProps2, child.props, {
          ref: function ref2(c) {
            setRef(child.ref, c);
            setRef(_ref, c);
          }
  ...
  return import_react61.default.createElement(ElementType, _extends({}, rest, {
    ...
    autoGenerateKey: false
  }), Icon_default.create(computeIcon(), {
    autoGenerateKey: false
...
Input.propTypes = true ? {
  ...
  action: import_prop_types53.default.oneOfType([import_prop_types53.default.bool, customPropTypes_exports.itemShorthand]),
  /** An action can appear along side an Input on the left or right. */
  actionPosition: import_prop_types53.default.oneOf(["left"]),
  /** Primary content. */
  ...
  fluid: import_prop_types53.default.bool,
  /** An Input field can show a user is currently interacting with it. */
  focus: import_prop_types53.default.bool,
  /** Optional Icon to display inside the Input. */
  icon: import_prop_types53.default.oneOfType([import_prop_types53.default.bool, customPropTypes_exports.itemShorthand]),
  /** An Icon can appear inside an Input on the left or right. */
  iconPosition: import_prop_types53.default.oneOf(["left"]),
  /** Shorthand for creating the HTML Input. */
  input: customPropTypes_exports.itemShorthand,
  /** Format to appear on dark backgrounds. */
  inverted: import_prop_types53.default.bool,
  /** Optional Label to display along side the Input. */
  label: customPropTypes_exports.itemShorthand,
  /** A Label can appear outside an Input on the left or right. */
  labelPosition: import_prop_types53.default.oneOf(["left", "right", "left corner", "right corner"]),
  ...
  size: import_prop_types53.default.oneOf(["mini", "small", "large", "big", "huge", "massive"]),
  /** An Input can receive focus. */
  ...
  transparent: import_prop_types53.default.bool,
  /** The HTML input type. */
...
// node_modules/semantic-ui-react/dist/es/collections/Form/FormInput.js
var FormInput = import_react62.default.forwardRef(function(props, ref2) {
  var control = props.control;
...
var FormRadio = import_react63.default.forwardRef(function(props, ref2) {
  var control = props.control;
...
var FormSelect = import_react64.default.forwardRef(function(props, ref2) {
...
FormSelect.propTypes = true ? {
  ...
  control: FormField_default.propTypes.control,
  /** Array of Dropdown.Item props e.g. `{ text: '', value: '' }` */
  options: import_prop_types56.default.arrayOf(import_prop_types56.default.shape(Dropdown_default.Item.propTypes)).isRequired
} : {};
...
var FormTextArea = import_react65.default.forwardRef(function(props, ref2) {
  var control = props.control;
...
// node_modules/semantic-ui-react/dist/es/collections/Form/Form.js
var Form = import_react66.default.forwardRef(function(props, ref2) {
  var action = props.action, children = props.children, className = props.className, error = props.error, inverted = props.inverted, loading = props.loading, reply = props.reply, size2 = props.size, success = props.success, unstackable = props.unstackable, warning2 = props.warning, widths = props.widths;
  var handleSubmit = function handleSubmit2(e) {
    if (typeof action !== "string") invoke_default(e, "preventDefault");
    for (var _len = arguments.length, args = new Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
      args[_key - 1] = arguments[_key];
    }
    invoke_default.apply(void 0, [props, "onSubmit", e, props].concat(args));
  };
  ...
  var rest = getUnhandledProps_default(Form, props);
  var ElementType = getElementType_default(Form, props);
...
Form.propTypes = true ? {
  ...
  action: import_prop_types58.default.string,
  /** Primary content. */
  ...
  inverted: import_prop_types58.default.bool,
  /** Automatically show a loading indicator. */
  loading: import_prop_types58.default.bool,
  /** The HTML form submit handler. */
  onSubmit: import_prop_types58.default.func,
  /** A comment can contain a form to reply to a comment. This may have arbitrary content. */
  reply: import_prop_types58.default.bool,
  /** A form can vary in size. */
  size: import_prop_types58.default.oneOf(without_default(SUI_exports.SIZES, "medium")),
  /** Automatically show any success Message children. */
  success: import_prop_types58.default.bool,
  /** A form can prevent itself from stacking on mobile. */
  unstackable: import_prop_types58.default.bool,
  /** Automatically show any warning Message children. */
  warning: import_prop_types58.default.bool,
  /** Forms can automatically divide fields to be equal width. */
  widths: import_prop_types58.default.oneOf(["equal"])
} : {};
Form.defaultProps = {
  as: "form"
};
...
var GridColumn = import_react67.default.forwardRef(function(props, ref2) {
...
GridColumn.propTypes = true ? {
  ...
  color: import_prop_types59.default.oneOf(SUI_exports.COLORS),
  /** A column can specify a width for a computer. */
  computer: customPropTypes_exports.every([customPropTypes_exports.disallow(["width"]), import_prop_types59.default.oneOf(SUI_exports.WIDTHS)]),
  /** A column can sit flush against the left or right edge of a row. */
  floated: import_prop_types59.default.oneOf(SUI_exports.FLOATS),
  /** A column can specify a width for a large screen device. */
  largeScreen: customPropTypes_exports.every([customPropTypes_exports.disallow(["width"]), import_prop_types59.default.oneOf(SUI_exports.WIDTHS)]),
  /** A column can specify a width for a mobile device. */
  mobile: customPropTypes_exports.every([customPropTypes_exports.disallow(["width"]), import_prop_types59.default.oneOf(SUI_exports.WIDTHS)]),
  /** A column can appear only for a specific device, or screen sizes. */
  only: customPropTypes_exports.multipleProp(SUI_exports.VISIBILITY),
  /** A column can stretch its contents to take up the entire grid or row height. */
  stretched: import_prop_types59.default.bool,
  /** A column can specify a width for a tablet device. */
  tablet: customPropTypes_exports.every([customPropTypes_exports.disallow(["width"]), import_prop_types59.default.oneOf(SUI_exports.WIDTHS)]),
  /** A column can specify its text alignment. */
  textAlign: import_prop_types59.default.oneOf(SUI_exports.TEXT_ALIGNMENTS),
  /** A column can specify its vertical alignment to have all its columns vertically centered. */
  verticalAlign: import_prop_types59.default.oneOf(SUI_exports.VERTICAL_ALIGNMENTS),
  /** A column can specify a width for a wide screen device. */
  widescreen: customPropTypes_exports.every([customPropTypes_exports.disallow(["width"]), import_prop_types59.default.oneOf(SUI_exports.WIDTHS)]),
  /** Represents width of column. */
  width: customPropTypes_exports.every([customPropTypes_exports.disallow(["computer", "largeScreen", "mobile", "tablet", "widescreen"]), import_prop_types59.default.oneOf(SUI_exports.WIDTHS)])
} : {};
...
var GridRow = import_react68.default.forwardRef(function(props, ref2) {
...
GridRow.propTypes = true ? {
  ...
  centered: import_prop_types60.default.bool,
  /** Primary content. */
  ...
  columns: import_prop_types60.default.oneOf([].concat(SUI_exports.WIDTHS, ["equal"])),
  /** A row can have dividers between its columns. */
  divided: import_prop_types60.default.bool,
...
// node_modules/semantic-ui-react/dist/es/collections/Grid/Grid.js
var Grid = import_react69.default.forwardRef(function(props, ref2) {
...
Grid.propTypes = true ? {
  ...
  celled: import_prop_types61.default.oneOfType([import_prop_types61.default.bool, import_prop_types61.default.oneOf(["internally"])]),
  ...
  divided: import_prop_types61.default.oneOfType([import_prop_types61.default.bool, import_prop_types61.default.oneOf(["vertically"])]),
  /** A grid can double its column width on tablet and mobile sizes. */
  doubling: import_prop_types61.default.bool,
  /** A grid's colors can be inverted. */
  inverted: import_prop_types61.default.bool,
  /** A grid can preserve its vertical and horizontal gutters on first and last columns. */
  padded: import_prop_types61.default.oneOfType([import_prop_types61.default.bool, import_prop_types61.default.oneOf(["horizontally", "vertically"])]),
  /** A grid can increase its gutters to allow for more negative space. */
  relaxed: import_prop_types61.default.oneOfType([import_prop_types61.default.bool, import_prop_types61.default.oneOf(["very"])]),
  /** A grid can specify that its columns should reverse order at different device sizes. */
  reversed: customPropTypes_exports.multipleProp(["computer", "computer vertically", "mobile", "mobile vertically", "tablet", "tablet vertically"]),
  /** A grid can have its columns stack on-top of each other after reaching mobile breakpoints. */
  stackable: import_prop_types61.default.bool,
...
var MessageContent = import_react70.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
...
var MessageHeader = import_react71.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("header", className);
...
var MessageItem = import_react72.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("content", className);
...
// node_modules/semantic-ui-react/dist/es/collections/Message/MessageList.js
var MessageList = import_react73.default.forwardRef(function(props, ref2) {
...
// node_modules/semantic-ui-react/dist/es/collections/Message/Message.js
var Message = import_react74.default.forwardRef(function(props, ref2) {
  var attached = props.attached, children = props.children, className = props.className, color = props.color, compact2 = props.compact, content = props.content, error = props.error, floating = props.floating, header = props.header, hidden = props.hidden, icon = props.icon, info = props.info, list = props.list, negative = props.negative, onDismiss = props.onDismiss, positive = props.positive, size2 = props.size, success = props.success, visible = props.visible, warning2 = props.warning;
  ...
  var rest = getUnhandledProps_default(Message, props);
  var ElementType = getElementType_default(Message, props);
  var handleDismiss = useEventCallback(function(e) {
    invoke_default(props, "onDismiss", e, props);
  });
  var dismissIcon = onDismiss && import_react74.default.createElement(Icon_default, {
    name: "close",
  ...
  return import_react74.default.createElement(ElementType, _extends({}, rest, {
    ...
    autoGenerateKey: false
  }), (!isNil_default(header) || !isNil_default(content) || !isNil_default(list)) && import_react74.default.createElement(MessageContent_default, null, MessageHeader_default.create(header, {
    autoGenerateKey: false
...
Message.propTypes = true ? {
  ...
  attached: import_prop_types66.default.oneOfType([import_prop_types66.default.bool, import_prop_types66.default.oneOf(["bottom", "top"])]),
  /** Primary content. */
  children: import_prop_types66.default.node,
  /** Additional classes. */
  className: import_prop_types66.default.string,
  /** A message can be formatted to be different colors. */
  color: import_prop_types66.default.oneOf(SUI_exports.COLORS),
  /** A message can only take up the width of its content. */
  compact: import_prop_types66.default.bool,
  /** Shorthand for primary content. */
  content: customPropTypes_exports.contentShorthand,
  /** A message may be formatted to display a negative message. Same as `negative`. */
  error: import_prop_types66.default.bool,
  /** A message can float above content that it is related to. */
  floating: import_prop_types66.default.bool,
  /** Shorthand for MessageHeader. */
  header: customPropTypes_exports.itemShorthand,
  /** A message can be hidden. */
  hidden: import_prop_types66.default.bool,
  /** A message can contain an icon. */
  icon: import_prop_types66.default.oneOfType([customPropTypes_exports.itemShorthand, import_prop_types66.default.bool]),
  /** A message may be formatted to display information. */
  info: import_prop_types66.default.bool,
  /** Array shorthand items for the MessageList. Mutually exclusive with children. */
  list: customPropTypes_exports.collectionShorthand,
  /** A message may be formatted to display a negative message. Same as `error`. */
  negative: import_prop_types66.default.bool,
  /**
   ...
   * @param {object} data - All props.
   */
  onDismiss: import_prop_types66.default.func,
  /** A message may be formatted to display a positive message.  Same as `success`. */
  positive: import_prop_types66.default.bool,
  /** A message can have different sizes. */
  size: import_prop_types66.default.oneOf(without_default(SUI_exports.SIZES, "medium")),
  /** A message may be formatted to display a positive message.  Same as `positive`. */
  success: import_prop_types66.default.bool,
  /** A message can be set to visible to force itself to be shown. */
  visible: import_prop_types66.default.bool,
  /** A message may be formatted to display warning messages. */
  warning: import_prop_types66.default.bool
} : {};
...
var TableBody = import_react75.default.forwardRef(function(props, ref2) {
...
var TableCell = import_react76.default.forwardRef(function(props, ref2) {
...
TableCell.propTypes = true ? {
  ...
  collapsing: import_prop_types68.default.bool,
  /** Shorthand for primary content. */
  content: customPropTypes_exports.contentShorthand,
  ...
  negative: import_prop_types68.default.bool,
  /** A cell may let a user know whether a value is good. */
  positive: import_prop_types68.default.bool,
  /** A cell can be selectable. */
  selectable: import_prop_types68.default.bool,
  /** A cell can specify that its contents should remain on a single line and not wrap. */
  singleLine: import_prop_types68.default.bool,
  /** A table cell can adjust its text alignment. */
  textAlign: import_prop_types68.default.oneOf(without_default(SUI_exports.TEXT_ALIGNMENTS, "justified")),
  /** A table cell can adjust its text alignment. */
  verticalAlign: import_prop_types68.default.oneOf(SUI_exports.VERTICAL_ALIGNMENTS),
  /** A cell may warn a user. */
  warning: import_prop_types68.default.bool,
  /** A table can specify the width of individual columns independently. */
  width: import_prop_types68.default.oneOf(SUI_exports.WIDTHS)
} : {};
...
var TableHeader = import_react77.default.forwardRef(function(props, ref2) {
...
// node_modules/semantic-ui-react/dist/es/collections/Table/TableFooter.js
var TableFooter = import_react78.default.forwardRef(function(props, ref2) {
  var as = props.as;
  var rest = getUnhandledProps_default(TableFooter, props);
  return import_react78.default.createElement(TableHeader_default, _extends({}, rest, {
    as,
    ref: ref2
  }));
});
...
var TableHeaderCell = import_react79.default.forwardRef(function(props, ref2) {
  ...
  return import_react79.default.createElement(TableCell_default, _extends({}, rest, {
    as,
    className: classes,
    ref: ref2
  }));
...
TableHeaderCell.propTypes = true ? {
  ...
  sorted: import_prop_types71.default.oneOf(["ascending", "descending"])
} : {};
...
var TableRow = import_react80.default.forwardRef(function(props, ref2) {
  ...
  if (!childrenUtils_exports.isNil(children)) {
    return import_react80.default.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
...
TableRow.propTypes = true ? {
  ...
  /** An element type to render as (string or function). */
  cellAs: import_prop_types72.default.elementType,
  ...
  negative: import_prop_types72.default.bool,
  /** A row may let a user know whether a value is good. */
  positive: import_prop_types72.default.bool,
  /** A table row can adjust its text alignment. */
  textAlign: import_prop_types72.default.oneOf(without_default(SUI_exports.TEXT_ALIGNMENTS, "justified")),
  /** A table row can adjust its vertical alignment. */
  verticalAlign: import_prop_types72.default.oneOf(SUI_exports.VERTICAL_ALIGNMENTS),
  /** A row may warn a user. */
  warning: import_prop_types72.default.bool
} : {};
...
// node_modules/semantic-ui-react/dist/es/collections/Table/Table.js
var Table = import_react81.default.forwardRef(function(props, ref2) {
  ...
  var headerElement = hasHeaderRows && import_react81.default.createElement(TableHeader_default, null, TableRow_default.create(headerRow, headerShorthandOptions), map_default(headerRows, function(data) {
    return TableRow_default.create(data, headerShorthandOptions);
  }));
  return import_react81.default.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), headerElement, import_react81.default.createElement(TableBody_default, null, renderBodyRow && map_default(tableData, function(data, index) {
    return TableRow_default.create(renderBodyRow(data, index));
  })), footerRow && import_react81.default.createElement(TableFooter_default, null, TableRow_default.create(footerRow)));
});
...
Table.propTypes = true ? {
  ...
  attached: import_prop_types73.default.oneOfType([import_prop_types73.default.bool, import_prop_types73.default.oneOf(["top", "bottom"])]),
  /** A table can reduce its complexity to increase readability. */
  basic: import_prop_types73.default.oneOfType([import_prop_types73.default.oneOf(["very"]), import_prop_types73.default.bool]),
  /** A table may be divided into individual cells. */
  celled: import_prop_types73.default.bool,
  /** Primary content. */
  children: import_prop_types73.default.node,
  /** Additional classes. */
  className: import_prop_types73.default.string,
  /** A table can be collapsing, taking up only as much space as its rows. */
  collapsing: import_prop_types73.default.bool,
  /** A table can be given a color to distinguish it from other tables. */
  color: import_prop_types73.default.oneOf(SUI_exports.COLORS),
  /** A table can specify its column count to divide its content evenly. */
  columns: import_prop_types73.default.oneOf(SUI_exports.WIDTHS),
  /** A table may sometimes need to be more compact to make more rows visible at a time. */
  compact: import_prop_types73.default.oneOfType([import_prop_types73.default.bool, import_prop_types73.default.oneOf(["very"])]),
  /** A table may be formatted to emphasize a first column that defines a rows content. */
  definition: import_prop_types73.default.bool,
  /**
   * A table can use fixed a special faster form of table rendering that does not resize table cells based on content
   */
  fixed: import_prop_types73.default.bool,
  ...
  inverted: import_prop_types73.default.bool,
  /** A table may sometimes need to be more padded for legibility. */
  padded: import_prop_types73.default.oneOfType([import_prop_types73.default.bool, import_prop_types73.default.oneOf(["very"])]),
  /**
   ...
   */
  renderBodyRow: customPropTypes_exports.every([customPropTypes_exports.disallow(["children"]), customPropTypes_exports.demand(["tableData"]), import_prop_types73.default.func]),
  /** A table can have its rows appear selectable. */
  selectable: import_prop_types73.default.bool,
  /** A table can specify that its cell contents should remain on a single line and not wrap. */
  singleLine: import_prop_types73.default.bool,
  /** A table can also be small or large. */
  size: import_prop_types73.default.oneOf(without_default(SUI_exports.SIZES, "mini", "tiny", "medium", "big", "huge", "massive")),
  /** A table may allow a user to sort contents by clicking on a table header. */
  sortable: import_prop_types73.default.bool,
  /** A table can specify how it stacks table content responsively. */
  stackable: import_prop_types73.default.bool,
  /** A table can stripe alternate rows of content with a darker color to increase contrast. */
  striped: import_prop_types73.default.bool,
  /** A table can be formatted to display complex structured data. */
  structured: import_prop_types73.default.bool,
  /** Data to be passed to the renderBodyRow function. */
  tableData: customPropTypes_exports.every([customPropTypes_exports.disallow(["children"]), customPropTypes_exports.demand(["renderBodyRow"]), import_prop_types73.default.array]),
  /** A table can adjust its text alignment. */
  textAlign: import_prop_types73.default.oneOf(without_default(SUI_exports.TEXT_ALIGNMENTS, "justified")),
  /** A table can specify how it stacks table content responsively. */
  unstackable: import_prop_types73.default.bool,
  /** A table can adjust its text alignment. */
...
var Container = import_react82.default.forwardRef(function(props, ref2) {
...
Container.propTypes = true ? {
  ...
  text: import_prop_types74.default.bool,
  /** Align container text. */
  textAlign: import_prop_types74.default.oneOf(SUI_exports.TEXT_ALIGNMENTS)
} : {};
...
var Divider = import_react83.default.forwardRef(function(props, ref2) {
...
Divider.propTypes = true ? {
  ...
  clearing: import_prop_types75.default.bool,
  /** Shorthand for primary content. */
  content: customPropTypes_exports.contentShorthand,
  /** Divider can be fitted without any space above or below it. */
  fitted: import_prop_types75.default.bool,
  /** Divider can divide content without creating a dividing line. */
  hidden: import_prop_types75.default.bool,
  /** Divider can segment content horizontally. */
  horizontal: import_prop_types75.default.bool,
  /** Divider can have its colours inverted. */
  inverted: import_prop_types75.default.bool,
  /** Divider can provide greater margins to divide sections of content. */
  section: import_prop_types75.default.bool,
  /** Divider can segment content vertically. */
  vertical: import_prop_types75.default.bool
} : {};
...
var HeaderSubheader = import_react84.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
...
var HeaderContent = import_react85.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("content", className);
...
// node_modules/semantic-ui-react/dist/es/elements/Header/Header.js
var Header = import_react86.default.forwardRef(function(props, ref2) {
  ...
  if (iconElement || imageElement) {
    return import_react86.default.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), iconElement || imageElement, (content || subheaderElement) && import_react86.default.createElement(HeaderContent_default, null, content, subheaderElement));
  }
  return import_react86.default.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
...
Header.propTypes = true ? {
  ...
  attached: import_prop_types78.default.oneOfType([import_prop_types78.default.bool, import_prop_types78.default.oneOf(["top", "bottom"])]),
  /** Format header to appear inside a content block. */
  block: import_prop_types78.default.bool,
  /** Primary content. */
  children: import_prop_types78.default.node,
  /** Additional classes. */
  className: import_prop_types78.default.string,
  /** Color of the header. */
  color: import_prop_types78.default.oneOf(SUI_exports.COLORS),
  /** Shorthand for primary content. */
  content: customPropTypes_exports.contentShorthand,
  /** Show that the header is inactive. */
  disabled: import_prop_types78.default.bool,
  /** Divide header from the content below it. */
  dividing: import_prop_types78.default.bool,
  /** Header can sit to the left or right of other content. */
  floated: import_prop_types78.default.oneOf(SUI_exports.FLOATS),
  /** Add an icon by icon name or pass an Icon. */
  icon: customPropTypes_exports.every([customPropTypes_exports.disallow(["image"]), import_prop_types78.default.oneOfType([import_prop_types78.default.bool, customPropTypes_exports.itemShorthand])]),
  /** Add an image by img src or pass an Image. */
  image: customPropTypes_exports.every([customPropTypes_exports.disallow(["icon"]), import_prop_types78.default.oneOfType([import_prop_types78.default.bool, customPropTypes_exports.itemShorthand])]),
  /** Inverts the color of the header for dark backgrounds. */
  inverted: import_prop_types78.default.bool,
  /** Content headings are sized with em and are based on the font-size of their container. */
  size: import_prop_types78.default.oneOf(without_default(SUI_exports.SIZES, "big", "massive", "mini")),
  /** Headers may be formatted to label smaller or de-emphasized content. */
  sub: import_prop_types78.default.bool,
  /** Shorthand for Header.Subheader. */
  subheader: customPropTypes_exports.itemShorthand,
  /** Align header content. */
  textAlign: import_prop_types78.default.oneOf(SUI_exports.TEXT_ALIGNMENTS)
} : {};
...
var ListDescription = import_react87.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
...
var ListHeader = import_react88.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("header", className);
...
// node_modules/semantic-ui-react/dist/es/elements/List/ListContent.js
var ListContent = import_react89.default.forwardRef(function(props, ref2) {
...
ListContent.propTypes = true ? {
  ...
  floated: import_prop_types81.default.oneOf(SUI_exports.FLOATS),
  /** Shorthand for ListHeader. */
  header: customPropTypes_exports.itemShorthand,
  /** An element inside a list can be vertically aligned. */
  verticalAlign: import_prop_types81.default.oneOf(SUI_exports.VERTICAL_ALIGNMENTS)
} : {};
...
var ListIcon = import_react90.default.forwardRef(function(props, ref2) {
  ...
  return import_react90.default.createElement(Icon_default, _extends({}, rest, {
    className: classes,
    ref: ref2
  }));
});
...
var ListItem = import_react91.default.forwardRef(function(props, ref2) {
  var active = props.active, children = props.children, className = props.className, content = props.content, description = props.description, disabled = props.disabled, header = props.header, icon = props.icon, image = props.image, value = props.value;
  var ElementType = getElementType_default(ListItem, props);
  ...
  var rest = getUnhandledProps_default(ListItem, props);
  var handleClick = useEventCallback(function(e) {
    if (!disabled) {
      invoke_default(props, "onClick", e, props);
    }
  ...
  if (!childrenUtils_exports.isNil(children)) {
    return import_react91.default.createElement(ElementType, _extends({}, valueProp, {
      role: "listitem"
    }, rest, {
      className: classes,
      onClick: handleClick,
  ...
  if (!(0, import_react91.isValidElement)(content) && isPlainObject_default(content)) {
    return import_react91.default.createElement(ElementType, _extends({}, valueProp, {
      role: "listitem"
    }, rest, {
      className: classes,
      onClick: handleClick,
      ref: ref2
    }), iconElement || imageElement, ListContent_default.create(content, {
      autoGenerateKey: false,
      defaultProps: {
        header,
        description
  ...
  if (iconElement || imageElement) {
    return import_react91.default.createElement(ElementType, _extends({}, valueProp, {
      ...
      onClick: handleClick,
      ref: ref2
    }), iconElement || imageElement, (content || headerElement || descriptionElement) && import_react91.default.createElement(ListContent_default, null, headerElement, descriptionElement, content));
  }
  return import_react91.default.createElement(ElementType, _extends({}, valueProp, {
    role: "listitem"
  }, rest, {
...
ListItem.propTypes = true ? {
  ...
  value: import_prop_types83.default.string
} : {};
...
var ListList = import_react92.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  ...
  return import_react92.default.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
// node_modules/semantic-ui-react/dist/es/elements/List/List.js
var List = import_react93.default.forwardRef(function(props, ref2) {
  var animated = props.animated, bulleted = props.bulleted, celled = props.celled, children = props.children, className = props.className, content = props.content, divided = props.divided, floated = props.floated, horizontal = props.horizontal, inverted = props.inverted, items = props.items, link = props.link, ordered = props.ordered, relaxed = props.relaxed, selection = props.selection, size2 = props.size, verticalAlign = props.verticalAlign;
  ...
  var rest = getUnhandledProps_default(List, props);
  var ElementType = getElementType_default(List, props);
  if (!childrenUtils_exports.isNil(children)) {
    return import_react93.default.createElement(ElementType, _extends({
      role: "list"
    }, rest, {
      className: classes,
      ref: ref2
...
List.propTypes = true ? {
  ...
  animated: import_prop_types85.default.bool,
  /** A list can mark items with a bullet. */
  bulleted: import_prop_types85.default.bool,
  /** A list can divide its items into cells. */
  celled: import_prop_types85.default.bool,
  /** Primary content. */
  ...
  divided: import_prop_types85.default.bool,
  /** An list can be floated left or right. */
  floated: import_prop_types85.default.oneOf(SUI_exports.FLOATS),
  /** A list can be formatted to have items appear horizontally. */
  horizontal: import_prop_types85.default.bool,
  /** A list can be inverted to appear on a dark background. */
  inverted: import_prop_types85.default.bool,
  /** Shorthand array of props for ListItem. */
  items: customPropTypes_exports.collectionShorthand,
  /** A list can be specially formatted for navigation links. */
  link: import_prop_types85.default.bool,
  /**
   ...
   * @param {object} data - All item props.
   */
  onItemClick: customPropTypes_exports.every([customPropTypes_exports.disallow(["children"]), import_prop_types85.default.func]),
  /** A list can be ordered numerically. */
  ordered: import_prop_types85.default.bool,
  /** A list can relax its padding to provide more negative space. */
  relaxed: import_prop_types85.default.oneOfType([import_prop_types85.default.bool, import_prop_types85.default.oneOf(["very"])]),
  /** A selection list formats list items as possible choices. */
  selection: import_prop_types85.default.bool,
  /** A list can vary in size. */
  size: import_prop_types85.default.oneOf(SUI_exports.SIZES),
  /** An element inside a list can be vertically aligned. */
  verticalAlign: import_prop_types85.default.oneOf(SUI_exports.VERTICAL_ALIGNMENTS)
} : {};
...
var Loader = import_react94.default.forwardRef(function(props, ref2) {
  ...
  return import_react94.default.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
Loader.propTypes = true ? {
  ...
  indeterminate: import_prop_types86.default.bool,
  /** Loaders can appear inline with content. */
  inline: import_prop_types86.default.oneOfType([import_prop_types86.default.bool, import_prop_types86.default.oneOf(["centered"])]),
...
var PlaceholderHeader = import_react95.default.forwardRef(function(props, ref2) {
...
PlaceholderHeader.propTypes = true ? {
  ...
  image: import_prop_types87.default.bool
} : {};
...
var PlaceholderImage = import_react96.default.forwardRef(function(props, ref2) {
...
PlaceholderImage.propTypes = true ? {
  ...
  square: customPropTypes_exports.every([customPropTypes_exports.disallow(["rectangular"]), import_prop_types88.default.bool]),
  /** An image can modify size correctly with responsive styles. */
  rectangular: customPropTypes_exports.every([customPropTypes_exports.disallow(["square"]), import_prop_types88.default.bool])
} : {};
...
var PlaceholderLine = import_react97.default.forwardRef(function(props, ref2) {
...
PlaceholderLine.propTypes = true ? {
  ...
  length: import_prop_types89.default.oneOf(["full", "very long", "long", "medium", "short", "very short"])
} : {};
...
var PlaceholderParagraph = import_react98.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
...
// node_modules/semantic-ui-react/dist/es/elements/Placeholder/Placeholder.js
var Placeholder = import_react99.default.forwardRef(function(props, ref2) {
...
Placeholder.propTypes = true ? {
  ...
  fluid: import_prop_types91.default.bool,
  /** A placeholder can have their colors inverted. */
  inverted: import_prop_types91.default.bool
} : {};
...
var Rail = import_react100.default.forwardRef(function(props, ref2) {
...
Rail.propTypes = true ? {
  ...
  attached: import_prop_types92.default.bool,
  /** Primary content. */
  children: import_prop_types92.default.node,
  /** Additional classes. */
  className: import_prop_types92.default.string,
  /** A rail can appear closer to the main viewport. */
  close: import_prop_types92.default.oneOfType([import_prop_types92.default.bool, import_prop_types92.default.oneOf(["very"])]),
  /** Shorthand for primary content. */
  content: customPropTypes_exports.contentShorthand,
  /** A rail can create a division between itself and a container. */
  dividing: import_prop_types92.default.bool,
  /** A rail can attach itself to the inside of a container. */
  internal: import_prop_types92.default.bool,
  /** A rail can be presented on the left or right side of a container. */
  position: import_prop_types92.default.oneOf(SUI_exports.FLOATS).isRequired,
  /** A rail can have different sizes. */
  size: import_prop_types92.default.oneOf(without_default(SUI_exports.SIZES, "medium"))
} : {};
...
var RevealContent = import_react101.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content, hidden = props.hidden, visible = props.visible;
...
RevealContent.propTypes = true ? {
  ...
  hidden: import_prop_types93.default.bool,
...
// node_modules/semantic-ui-react/dist/es/elements/Reveal/Reveal.js
var Reveal = import_react102.default.forwardRef(function(props, ref2) {
...
Reveal.propTypes = true ? {
  ...
  animated: import_prop_types94.default.oneOf(["fade", "small fade", "move", "move right", "move up", "move down", "rotate", "rotate left"]),
  /** Primary content. */
  ...
  instant: import_prop_types94.default.bool
} : {};
...
var SegmentGroup = import_react103.default.forwardRef(function(props, ref2) {
...
SegmentGroup.propTypes = true ? {
  ...
  compact: import_prop_types95.default.bool,
  /** Shorthand for primary content. */
  content: customPropTypes_exports.contentShorthand,
  /** Formats content to be aligned horizontally. */
  horizontal: import_prop_types95.default.bool,
  /** Formatted to look like a pile of pages. */
  piled: import_prop_types95.default.bool,
  /** A segment group may be formatted to raise above the page. */
  raised: import_prop_types95.default.bool,
  /** A segment group can have different sizes. */
  size: import_prop_types95.default.oneOf(without_default(SUI_exports.SIZES, "medium")),
  /** Formatted to show it contains multiple pages. */
  stacked: import_prop_types95.default.bool
} : {};
...
var SegmentInline = import_react104.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
...
// node_modules/semantic-ui-react/dist/es/elements/Segment/Segment.js
var Segment = import_react105.default.forwardRef(function(props, ref2) {
...
Segment.propTypes = true ? {
  ...
  attached: import_prop_types97.default.oneOfType([import_prop_types97.default.bool, import_prop_types97.default.oneOf(["top", "bottom"])]),
  /** A basic segment has no special formatting. */
  basic: import_prop_types97.default.bool,
  /** Primary content. */
  children: import_prop_types97.default.node,
  /** A segment can be circular. */
  circular: import_prop_types97.default.bool,
  /** Additional classes. */
  className: import_prop_types97.default.string,
  /** A segment can clear floated content. */
  clearing: import_prop_types97.default.bool,
  /** Segment can be colored. */
  color: import_prop_types97.default.oneOf(SUI_exports.COLORS),
  /** A segment may take up only as much space as is necessary. */
  compact: import_prop_types97.default.bool,
  /** Shorthand for primary content. */
  content: customPropTypes_exports.contentShorthand,
  /** A segment may show its content is disabled. */
  disabled: import_prop_types97.default.bool,
  /** Segment content can be floated to the left or right. */
  floated: import_prop_types97.default.oneOf(SUI_exports.FLOATS),
  /** A segment can have its colors inverted for contrast. */
  inverted: import_prop_types97.default.bool,
  /** A segment may show its content is being loaded. */
  loading: import_prop_types97.default.bool,
  /** A segment can increase its padding. */
  padded: import_prop_types97.default.oneOfType([import_prop_types97.default.bool, import_prop_types97.default.oneOf(["very"])]),
  /** A segment can be used to reserve space for conditionally displayed content. */
  placeholder: import_prop_types97.default.bool,
  /** Formatted to look like a pile of pages. */
  piled: import_prop_types97.default.bool,
  /** A segment may be formatted to raise above the page. */
  raised: import_prop_types97.default.bool,
  /** A segment can be formatted to appear less noticeable. */
  secondary: import_prop_types97.default.bool,
  /** A segment can have different sizes. */
  size: import_prop_types97.default.oneOf(without_default(SUI_exports.SIZES, "medium")),
  /** Formatted to show it contains multiple pages. */
  stacked: import_prop_types97.default.bool,
  /** A segment can be formatted to appear even less noticeable. */
  tertiary: import_prop_types97.default.bool,
  /** Formats content to be aligned as part of a vertical group. */
  textAlign: import_prop_types97.default.oneOf(without_default(SUI_exports.TEXT_ALIGNMENTS, "justified")),
  /** Formats content to be aligned vertically. */
  vertical: import_prop_types97.default.bool
} : {};
...
var StepDescription = import_react106.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("description", className);
...
var StepTitle = import_react107.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
...
// node_modules/semantic-ui-react/dist/es/elements/Step/StepContent.js
var StepContent = import_react108.default.forwardRef(function(props, ref2) {
...
var StepGroup = import_react109.default.forwardRef(function(props, ref2) {
...
StepGroup.propTypes = true ? {
  ...
  attached: import_prop_types101.default.oneOfType([import_prop_types101.default.bool, import_prop_types101.default.oneOf(["top", "bottom"])]),
  /** Primary content. */
  ...
  fluid: import_prop_types101.default.bool,
  /** Shorthand array of props for Step. */
  items: customPropTypes_exports.collectionShorthand,
  /** A step can show a ordered sequence of steps. */
  ordered: import_prop_types101.default.bool,
  /** Steps can have different sizes. */
  size: import_prop_types101.default.oneOf(without_default(SUI_exports.SIZES, "medium")),
  /** A step can stack vertically only on smaller screens. */
  stackable: import_prop_types101.default.oneOf(["tablet"]),
  /** A step can prevent itself from stacking on mobile. */
  unstackable: import_prop_types101.default.bool,
  /** A step can be displayed stacked vertically. */
  vertical: import_prop_types101.default.bool,
  /** Steps can be divided evenly inside their parent. */
  widths: import_prop_types101.default.oneOf([].concat(keys_default(numberMap), keys_default(numberMap).map(Number), values_default(numberMap)))
} : {};
var StepGroup_default = StepGroup;

// node_modules/semantic-ui-react/dist/es/elements/Step/Step.js
var Step = import_react110.default.forwardRef(function(props, ref2) {
  var active = props.active, children = props.children, className = props.className, completed = props.completed, content = props.content, description = props.description, disabled = props.disabled, href = props.href, onClick = props.onClick, icon = props.icon, link = props.link, title = props.title;
  var handleClick = useEventCallback(function(e) {
    if (!disabled) {
      invoke_default(props, "onClick", e, props);
    }
  ...
  var rest = getUnhandledProps_default(Step, props);
  var ElementType = getElementType_default(Step, props, function() {
    if (onClick) {
      return "a";
    }
  });
...
Step.propTypes = true ? {
  ...
  completed: import_prop_types102.default.bool,
  /** Shorthand for primary content. */
  content: customPropTypes_exports.contentShorthand,
  /** Shorthand for StepDescription. */
  description: customPropTypes_exports.itemShorthand,
  ...
  icon: customPropTypes_exports.itemShorthand,
  /** A step can be link. */
  link: import_prop_types102.default.bool,
  /**
   * Called on click. When passed, the component will render as an `a`
   * tag by default instead of a `div`.
   *
...
var AccordionTitle = import_react111.default.forwardRef(function(props, ref2) {
  var active = props.active, children = props.children, className = props.className, content = props.content, icon = props.icon;
  var classes = clsx_m_default(useKeyOnly(active, "active"), "title", className);
  var rest = getUnhandledProps_default(AccordionTitle, props);
  var ElementType = getElementType_default(AccordionTitle, props);
...
AccordionTitle.propTypes = true ? {
  ...
  index: import_prop_types103.default.oneOfType([import_prop_types103.default.string, import_prop_types103.default.number]),
  /**
   * Called on click.
   *
   * @param {SyntheticEvent} event - React's original SyntheticEvent.
...
var AccordionTitle_default = AccordionTitle;
...
var AccordionContent = import_react112.default.forwardRef(function(props, ref2) {
...
var AccordionPanel = function(_Component) {
  ...
  _proto.render = function render() {
    ...
    return import_react113.default.createElement(import_react113.default.Fragment, null, AccordionTitle_default.create(title, {
      autoGenerateKey: false,
      defaultProps: {
        active,
        index
...
AccordionPanel.propTypes = true ? {
  ...
  content: customPropTypes_exports.itemShorthand,
  /** A panel index. */
  index: import_prop_types105.default.oneOfType([import_prop_types105.default.number, import_prop_types105.default.string]),
  /**
   ...
   * @param {object} data - All item props.
   */
  onTitleClick: import_prop_types105.default.func,
...
function isIndexActive(exclusive, activeIndex, itemIndex) {
  return exclusive ? activeIndex === itemIndex : includes_default(activeIndex, itemIndex);
}
function computeNewIndex(exclusive, activeIndex, itemIndex) {
  if (exclusive) {
    return itemIndex === activeIndex ? -1 : itemIndex;
  }
  if (includes_default(activeIndex, itemIndex)) {
    return without_default(activeIndex, itemIndex);
  }
  return [].concat(activeIndex, [itemIndex]);
}
var AccordionAccordion = import_react114.default.forwardRef(function(props, ref2) {
  var className = props.className, children = props.children, exclusive = props.exclusive, panels = props.panels;
  var _useAutoControlledVal = useAutoControlledValue_default({
    state: props.activeIndex,
    defaultState: props.defaultActiveIndex,
  ...
  var rest = getUnhandledProps_default(AccordionAccordion, props);
  var ElementType = getElementType_default(AccordionAccordion, props);
  var handleTitleClick = useEventCallback(function(e, titleProps) {
    ...
    invoke_default(props, "onTitleClick", e, titleProps);
  });
  if (true) {
    import_react114.default.useEffect(function() {
  ...
  return import_react114.default.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
...
AccordionAccordion.propTypes = true ? {
  ...
  activeIndex: customPropTypes_exports.every([customPropTypes_exports.disallow(["children"]), import_prop_types106.default.oneOfType([import_prop_types106.default.arrayOf(import_prop_types106.default.number), import_prop_types106.default.number])]),
  /** Primary content. */
  children: import_prop_types106.default.node,
  /** Additional classes. */
  className: import_prop_types106.default.string,
  /** Initial activeIndex value. */
  defaultActiveIndex: customPropTypes_exports.every([customPropTypes_exports.disallow(["children"]), import_prop_types106.default.oneOfType([import_prop_types106.default.arrayOf(import_prop_types106.default.number), import_prop_types106.default.number])]),
   ...
   * @param {object} data - All item props.
   */
  onTitleClick: customPropTypes_exports.every([customPropTypes_exports.disallow(["children"]), import_prop_types106.default.func]),
  /** Shorthand array of props for Accordion. */
  panels: customPropTypes_exports.every([customPropTypes_exports.disallow(["children"]), import_prop_types106.default.arrayOf(import_prop_types106.default.shape({
    content: customPropTypes_exports.itemShorthand,
    title: customPropTypes_exports.itemShorthand
  }))])
} : {};
...
var AccordionAccordion_default = AccordionAccordion;

// node_modules/semantic-ui-react/dist/es/modules/Accordion/Accordion.js
var Accordion = import_react115.default.forwardRef(function(props, ref2) {
  ...
  return import_react115.default.createElement(AccordionAccordion_default, _extends({}, rest, {
    className: classes,
    ref: ref2
  }));
});
...
Accordion.propTypes = true ? {
  ...
  fluid: import_prop_types107.default.bool,
  /** Format for dark backgrounds. */
  inverted: import_prop_types107.default.bool,
  /** Adds some basic styling to accordion panels. */
  styled: import_prop_types107.default.bool
} : {};
Accordion.Accordion = AccordionAccordion_default;
Accordion.Content = AccordionContent_default;
Accordion.Panel = AccordionPanel_default;
Accordion.Title = AccordionTitle_default;
...
var Embed = import_react116.default.forwardRef(function(props, ref2) {
  var aspectRatio = props.aspectRatio, _props$autoplay = props.autoplay, autoplay = _props$autoplay === void 0 ? true : _props$autoplay, _props$brandedUI = props.brandedUI, brandedUI = _props$brandedUI === void 0 ? false : _props$brandedUI, children = props.children, className = props.className, _props$color = props.color, color = _props$color === void 0 ? "#444444" : _props$color, content = props.content, _props$hd = props.hd, hd = _props$hd === void 0 ? true : _props$hd, icon = props.icon, id = props.id, iframe = props.iframe, placeholder = props.placeholder, source = props.source, url = props.url;
  var _useAutoControlledVal = useAutoControlledValue_default({
    state: props.active,
    defaultState: props.defaultActive,
    initialState: false
  }), active = _useAutoControlledVal[0], setActive = _useAutoControlledVal[1];
  var getSrc = function getSrc2() {
    if (source === "youtube") {
  ...
  var renderEmbed = function renderEmbed2() {
    if (!active) {
      return null;
    }
    if (!childrenUtils_exports.isNil(children)) {
    ...
    return import_react116.default.createElement("div", {
      className: "embed"
    }, createHTMLIframe(childrenUtils_exports.isNil(iframe) ? getSrc() : iframe, {
      defaultProps: {
  ...
  var rest = getUnhandledProps_default(Embed, props);
  var ElementType = getElementType_default(Embed, props);
  var iconShorthand = icon !== void 0 ? icon : "video play";
  return import_react116.default.createElement(ElementType, _extends({}, rest, {
    className: classes,
    onClick: handleClick,
    ref: ref2
  }), Icon_default.create(iconShorthand, {
    autoGenerateKey: false
  }), placeholder && import_react116.default.createElement("img", {
...
Embed.propTypes = true ? {
  /** An element type to render as (string or function). */
  as: import_prop_types108.default.elementType,
  /** An embed can be active. */
  active: import_prop_types108.default.bool,
  /** An embed can specify an alternative aspect ratio. */
  aspectRatio: import_prop_types108.default.oneOf(["4:3", "16:9", "21:9"]),
  /** Setting to true or false will force autoplay. */
  autoplay: customPropTypes_exports.every([customPropTypes_exports.demand(["source"]), import_prop_types108.default.bool]),
  /** Whether to show networks branded UI like title cards, or after video calls to action. */
  brandedUI: customPropTypes_exports.every([customPropTypes_exports.demand(["source"]), import_prop_types108.default.bool]),
  /** Primary content. */
  children: import_prop_types108.default.node,
  /** Additional classes. */
  className: import_prop_types108.default.string,
  /** Specifies a default chrome color with Vimeo or YouTube. */
  color: customPropTypes_exports.every([customPropTypes_exports.demand(["source"]), import_prop_types108.default.string]),
  /** Shorthand for primary content. */
  content: customPropTypes_exports.contentShorthand,
  /** Initial value of active. */
  defaultActive: import_prop_types108.default.bool,
  /** Whether to prefer HD content. */
  hd: customPropTypes_exports.every([customPropTypes_exports.demand(["source"]), import_prop_types108.default.bool]),
  /** Specifies an icon to use with placeholder content. */
  icon: customPropTypes_exports.itemShorthand,
  /** Specifies an id for source. */
  id: customPropTypes_exports.every([customPropTypes_exports.demand(["source"]), import_prop_types108.default.string]),
  ...
  source: customPropTypes_exports.every([customPropTypes_exports.disallow(["sourceUrl"]), import_prop_types108.default.oneOf(["youtube", "vimeo"])]),
  /** Specifies a url to use for embed. */
  url: customPropTypes_exports.every([customPropTypes_exports.disallow(["source"]), import_prop_types108.default.string])
} : {};
...
var ManagerReferenceNodeContext = React123.createContext();
var ManagerReferenceNodeSetterContext = React123.createContext();
...
var setRef2 = function setRef3(ref2, node) {
  if (typeof ref2 === "function") {
...
var useIsomorphicLayoutEffect2 = typeof window !== "undefined" && window.document && window.document.createElement ? React124.useLayoutEffect : React124.useEffect;
...
var usePopper = function usePopper2(referenceElement, popperElement, options) {
  ...
  var prevOptions = React125.useRef(null);
  ...
  var _React$useState = React125.useState({
    styles: {
      popper: {
  ...
  var updateStateModifier = React125.useMemo(function() {
    return {
      name: "updateState",
      enabled: true,
      phase: "write",
  ...
  var popperOptions = React125.useMemo(function() {
    var newOptions = {
  ...
  var popperInstanceRef = React125.useRef();
...
function Popper(_ref) {
  ...
  var referenceNode = React126.useContext(ManagerReferenceNodeContext);
  var _React$useState = React126.useState(null), popperElement = _React$useState[0], setPopperElement = _React$useState[1];
  var _React$useState2 = React126.useState(null), arrowElement = _React$useState2[0], setArrowElement = _React$useState2[1];
  React126.useEffect(function() {
    setRef2(innerRef, popperElement);
  }, [innerRef, popperElement]);
  var options = React126.useMemo(function() {
    return {
      placement,
      strategy,
      onFirstUpdate,
  ...
  var childrenProps = React126.useMemo(function() {
    return {
...
var PopupContent = import_react117.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("content", className);
...
var PopupHeader = import_react118.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("header", className);
...
var PopupHeader_default = PopupHeader;

// node_modules/semantic-ui-react/dist/es/modules/Popup/Popup.js
function getPortalProps(props) {
  var portalProps = {};
  var normalizedOn = isArray_default(props.on) ? props.on : [props.on];
  if (props.hoverable) {
...
function usePositioningEffect(popperDependencies, positionUpdate) {
  var previousDependencies = usePrevious_default(popperDependencies);
  useIsomorphicLayoutEffect_default(function() {
    if (positionUpdate.current) {
      positionUpdate.current();
    }
  }, [(0, import_shallowequal3.default)(previousDependencies, popperDependencies)]);
}
var Popup = import_react119.default.forwardRef(function(props, ref2) {
  var basic = props.basic, className = props.className, content = props.content, context = props.context, children = props.children, disabled = props.disabled, eventsEnabled = props.eventsEnabled, flowing = props.flowing, header = props.header, inverted = props.inverted, offset2 = props.offset, pinned = props.pinned, popper2 = props.popper, popperDependencies = props.popperDependencies, popperModifiers = props.popperModifiers, position = props.position, positionFixed = props.positionFixed, size2 = props.size, style = props.style, trigger = props.trigger, wide = props.wide;
  var _React$useState = import_react119.default.useState(false), closed = _React$useState[0], setClosed = _React$useState[1];
  var unhandledProps = getUnhandledProps_default(Popup, props);
  var _partitionPortalProps = partitionPortalProps(unhandledProps, closed, disabled), contentRestProps = _partitionPortalProps.contentRestProps, portalRestProps = _partitionPortalProps.portalRestProps;
  var elementRef = useMergedRefs(ref2);
  var positionUpdate = import_react119.default.useRef();
  var timeoutId = import_react119.default.useRef();
  var triggerRef = import_react119.default.useRef();
  var zIndexWasSynced = import_react119.default.useRef(false);
  ...
  var hideOnScroll = function hideOnScroll2(e) {
    if (isElement_default(e.target) && elementRef.current.contains(e.target)) {
      return;
    }
    setClosed(true);
  ...
  var renderBody = function renderBody2(_ref) {
    ...
    var ElementType = getElementType_default(Popup, props);
    var styles = _extends({
    ...
    var innerElement = import_react119.default.createElement(ElementType, _extends({}, contentRestProps, {
      className: classes,
      style: styles,
      ref: elementRef
    }), childrenUtils_exports.isNil(children) ? import_react119.default.createElement(import_react119.default.Fragment, null, PopupHeader_default.create(header, {
      autoGenerateKey: false
    }), PopupContent_default.create(content, {
      autoGenerateKey: false
    })) : children, hideOnScroll && import_react119.default.createElement(import_event_stack4.default, {
      on: hideOnScroll,
      name: "scroll",
      target: "window"
    }));
  ...
  var referenceElement = createReferenceProxy_default(isNil_default(context) ? triggerRef : context);
  var mergedPortalProps = _extends({}, getPortalProps(props), portalRestProps);
  return import_react119.default.createElement(Portal_default, _extends({}, mergedPortalProps, {
    onClose: handleClose,
    onMount: handlePortalMount,
    onOpen: handleOpen,
    onUnmount: handlePortalUnmount,
    trigger,
    triggerRef
  }), import_react119.default.createElement(Popper, {
    modifiers,
...
Popup.propTypes = true ? {
  ...
  basic: import_prop_types111.default.bool,
  /** Primary content. */
  ...
  context: import_prop_types111.default.oneOfType([import_prop_types111.default.object, customPropTypes_exports.refObject]),
  /** A disabled popup only renders its trigger. */
  disabled: import_prop_types111.default.bool,
  /** Enables the Popper.js event listeners. */
  eventsEnabled: import_prop_types111.default.bool,
  /** A flowing Popup has no maximum width and continues to flow to fit its content. */
  flowing: import_prop_types111.default.bool,
  ...
  hideOnScroll: import_prop_types111.default.bool,
  /** Whether the popup should not close on hover. */
  hoverable: import_prop_types111.default.bool,
  /** Invert the colors of the Popup. */
  inverted: import_prop_types111.default.bool,
  /**
   ...
   */
  offset: import_prop_types111.default.oneOfType([import_prop_types111.default.func, import_prop_types111.default.arrayOf(import_prop_types111.default.number)]),
  /** Events triggering the popup. */
  on: import_prop_types111.default.oneOfType([import_prop_types111.default.oneOf(["hover", "click", "focus"]), import_prop_types111.default.arrayOf(import_prop_types111.default.oneOf(["hover", "click", "focus"]))]),
  /**
   * Called when a close event happens.
   *
   * @param {SyntheticEvent} event - React's original SyntheticEvent.
   ...
   * @param {object} data - All props.
   */
  onMount: import_prop_types111.default.func,
  /**
   * Called when an open event happens.
   *
   * @param {SyntheticEvent} event - React's original SyntheticEvent.
   ...
   * @param {object} data - All props.
   */
  onUnmount: import_prop_types111.default.func,
  /** Disables automatic repositioning of the component, it will always be placed according to the position value. */
  pinned: import_prop_types111.default.bool,
  /** Position for the popover. */
  position: import_prop_types111.default.oneOf(positions),
  /** Tells `Popper.js` to use the `position: fixed` strategy to position the popover. */
  positionFixed: import_prop_types111.default.bool,
  ...
  popperModifiers: import_prop_types111.default.array,
  /** A popup can have dependencies which update will schedule a position update. */
  popperDependencies: import_prop_types111.default.array,
  /** Popup size. */
  size: import_prop_types111.default.oneOf(without_default(SUI_exports.SIZES, "medium", "big", "massive")),
  /** Custom Popup style. */
  style: import_prop_types111.default.object,
  /** Element to be rendered in-place where the popup is defined. */
  trigger: import_prop_types111.default.node,
  /** Popup width. */
  wide: import_prop_types111.default.oneOfType([import_prop_types111.default.bool, import_prop_types111.default.oneOf(["very"])])
} : {};
Popup.defaultProps = {
  disabled: false,
  eventsEnabled: true,
...
Popup.Content = PopupContent_default;
Popup.Header = PopupHeader_default;
...
function getPercent(percent, total, value, progress, precision) {
  var clampedPercent = clamp_default(calculatePercent(percent, total, value), 0, 100);
  ...
  return round_default(clampedPercent, precision);
}
var Progress = import_react120.default.forwardRef(function(props, ref2) {
  var active = props.active, autoSuccess = props.autoSuccess, attached = props.attached, children = props.children, className = props.className, color = props.color, content = props.content, disabled = props.disabled, error = props.error, indicating = props.indicating, inverted = props.inverted, label = props.label, percent = props.percent, precision = props.precision, progress = props.progress, total = props.total, size2 = props.size, success = props.success, value = props.value, warning2 = props.warning;
  ...
  var computeValueText = function computeValueText2() {
    if (progress === "value") {
      return value;
    }
    if (progress === "ratio") {
  ...
  var rest = getUnhandledProps_default(Progress, props);
  var ElementType = getElementType_default(Progress, props);
  return import_react120.default.createElement(ElementType, _extends({}, rest, {
    className: classes,
...
Progress.propTypes = true ? {
  ...
  attached: import_prop_types112.default.oneOf(["top", "bottom"]),
  /** Whether success state should automatically trigger when progress completes. */
  autoSuccess: import_prop_types112.default.bool,
  /** Primary content. */
  children: import_prop_types112.default.node,
  /** Additional classes. */
  className: import_prop_types112.default.string,
  /** A progress bar can have different colors. */
  color: import_prop_types112.default.oneOf(SUI_exports.COLORS),
  /** Shorthand for primary content. */
  content: customPropTypes_exports.contentShorthand,
  ...
  indicating: import_prop_types112.default.bool,
  /** A progress bar can have its colors inverted. */
  inverted: import_prop_types112.default.bool,
  /** Can be set to either to display progress as percent or ratio. */
  label: customPropTypes_exports.itemShorthand,
  /** Current percent complete. */
  percent: customPropTypes_exports.every([customPropTypes_exports.disallow(["total", "value"]), import_prop_types112.default.oneOfType([import_prop_types112.default.number, import_prop_types112.default.string])]),
  /** Decimal point precision for calculated progress. */
  precision: import_prop_types112.default.number,
  /** A progress bar can contain a text value indicating current progress. */
  progress: import_prop_types112.default.oneOfType([import_prop_types112.default.bool, import_prop_types112.default.oneOf(["percent", "ratio", "value"])]),
  /** A progress bar can vary in size. */
  size: import_prop_types112.default.oneOf(without_default(SUI_exports.SIZES, "mini", "huge", "massive")),
  /** A progress bar can show a success state. */
  success: import_prop_types112.default.bool,
  /** For use with value. Together, these will calculate the percent. Mutually excludes percent. */
  total: customPropTypes_exports.every([customPropTypes_exports.demand(["value"]), customPropTypes_exports.disallow(["percent"]), import_prop_types112.default.oneOfType([import_prop_types112.default.number, import_prop_types112.default.string])]),
  /** For use with total. Together, these will calculate the percent. Mutually excludes percent. */
  value: customPropTypes_exports.every([customPropTypes_exports.disallow(["percent"]), import_prop_types112.default.oneOfType([import_prop_types112.default.number, import_prop_types112.default.string])]),
  /** A progress bar can show a warning state. */
  warning: import_prop_types112.default.bool
} : {};
...
var RatingIcon = import_react121.default.forwardRef(function(props, ref2) {
  var active = props.active, className = props.className, selected = props.selected;
  var classes = clsx_m_default(useKeyOnly(active, "active"), useKeyOnly(selected, "selected"), "icon", className);
  var rest = getUnhandledProps_default(RatingIcon, props);
  var ElementType = getElementType_default(RatingIcon, props);
  var handleClick = function handleClick2(e) {
    invoke_default(props, "onClick", e, props);
  };
  var handleKeyUp = function handleKeyUp2(e) {
    invoke_default(props, "onKeyUp", e, props);
  ...
  var handleMouseEnter = function handleMouseEnter2(e) {
    invoke_default(props, "onMouseEnter", e, props);
  };
  return import_react121.default.createElement(ElementType, _extends({
    role: "radio"
  }, rest, {
    className: classes,
    onClick: handleClick,
...
RatingIcon.propTypes = true ? {
   ...
   * @param {object} data - All props.
   */
  onKeyUp: import_prop_types113.default.func,
  /**
   ...
   * @param {object} data - All props.
   */
  onMouseEnter: import_prop_types113.default.func,
...
var RatingIcon_default = RatingIcon;

// node_modules/semantic-ui-react/dist/es/modules/Rating/Rating.js
var Rating = import_react122.default.forwardRef(function(props, ref2) {
  var className = props.className, clearable = props.clearable, disabled = props.disabled, icon = props.icon, maxRating = props.maxRating, size2 = props.size;
  var _useAutoControlledVal = useAutoControlledValue_default({
    state: props.rating,
    defaultState: props.defaultRating,
    initialState: 0
  }), rating = _useAutoControlledVal[0], setRating = _useAutoControlledVal[1];
  var _React$useState = import_react122.default.useState(-1), selectedIndex = _React$useState[0], setSelectedIndex = _React$useState[1];
  var _React$useState2 = import_react122.default.useState(false), isSelecting = _React$useState2[0], setIsSelecting = _React$useState2[1];
  ...
  var rest = getUnhandledProps_default(Rating, props);
  var ElementType = getElementType_default(Rating, props);
  var handleIconClick = function handleIconClick2(e, _ref) {
    ...
    invoke_default(props, "onRate", e, _extends({}, props, {
      rating: newRating
    }));
  };
  var handleIconMouseEnter = function handleIconMouseEnter2(e, _ref2) {
  ...
  var handleMouseLeave = function handleMouseLeave2() {
    ...
    invoke_default.apply(void 0, [props, "onMouseLeave"].concat(args));
    if (disabled) {
      return;
    }
    setSelectedIndex(-1);
  ...
  return import_react122.default.createElement(ElementType, _extends({
    role: "radiogroup"
  }, rest, {
    className: classes,
    ...
    return (
      ...
      import_react122.default.createElement(RatingIcon_default, {
        tabIndex: disabled ? -1 : 0,
        active: rating >= i + 1,
...
Rating.propTypes = true ? {
   ...
   */
  clearable: import_prop_types114.default.oneOfType([import_prop_types114.default.bool, import_prop_types114.default.oneOf(["auto"])]),
  /** The initial rating value. */
  defaultRating: import_prop_types114.default.oneOfType([import_prop_types114.default.number, import_prop_types114.default.string]),
  /** You can disable or enable interactive rating.  Makes a read-only rating. */
  disabled: import_prop_types114.default.bool,
  /** A rating can use a set of star or heart icons. */
  icon: import_prop_types114.default.oneOf(["star", "heart"]),
  /** The total number of icons. */
  maxRating: import_prop_types114.default.oneOfType([import_prop_types114.default.number, import_prop_types114.default.string]),
  /**
   ...
   */
  onRate: import_prop_types114.default.func,
  /** The current number of active icons. */
  rating: import_prop_types114.default.oneOfType([import_prop_types114.default.number, import_prop_types114.default.string]),
  /** A progress bar can vary in size. */
  size: import_prop_types114.default.oneOf(without_default(SUI_exports.SIZES, "medium", "big"))
} : {};
Rating.defaultProps = {
  clearable: "auto",
  maxRating: 1
};
Rating.Icon = RatingIcon_default;
...
function SearchCategoryLayout(props) {
  ...
  return import_react123.default.createElement(import_react123.default.Fragment, null, import_react123.default.createElement("div", {
    className: "name"
  }, categoryContent), import_react123.default.createElement("div", {
    className: "results"
  }, resultsContent));
}
...
SearchCategoryLayout.propTypes = true ? {
  ...
  categoryContent: import_prop_types115.default.element.isRequired,
  /** The rendered results content */
  resultsContent: import_prop_types115.default.element.isRequired
} : {};
var SearchCategoryLayout_default = SearchCategoryLayout;

// node_modules/semantic-ui-react/dist/es/modules/Search/SearchCategory.js
var SearchCategory = import_react124.default.forwardRef(function(props, ref2) {
  ...
  return import_react124.default.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), layoutRenderer({
    categoryContent,
...
SearchCategory.propTypes = true ? {
   ...
   */
  layoutRenderer: import_prop_types116.default.func,
  /**
   ...
   */
  renderer: import_prop_types116.default.func,
  /** Array of Search.Result props. */
  results: import_prop_types116.default.array
} : {};
...
var defaultRenderer = function defaultRenderer2(_ref) {
  ...
  return [image && import_react125.default.createElement("div", {
    key: "image",
    className: "image"
    ...
    key: "content",
    className: "content"
  }, price && import_react125.default.createElement("div", {
    className: "price"
  }, price), title && import_react125.default.createElement("div", {
    className: "title"
  }, title), description && import_react125.default.createElement("div", {
    className: "description"
  }, description))];
};
defaultRenderer.handledProps = [];
var SearchResult = import_react125.default.forwardRef(function(props, ref2) {
  var active = props.active, className = props.className, renderer2 = props.renderer;
  var handleClick = function handleClick2(e) {
    invoke_default(props, "onClick", e, props);
  };
  var classes = clsx_m_default(useKeyOnly(active, "active"), "result", className);
  var rest = getUnhandledProps_default(SearchResult, props);
  var ElementType = getElementType_default(SearchResult, props);
...
SearchResult.propTypes = true ? {
  ...
  price: import_prop_types117.default.string,
  /**
  ...
  /** Display title. */
  title: import_prop_types117.default.string.isRequired
} : {};
...
var SearchResults = import_react126.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
...
var Search = import_react127.default.forwardRef(function(props, ref2) {
  return import_react127.default.createElement(SearchInner, _extends({}, props, {
    innerRef: ref2
  }));
});
...
var SearchInner = function(_Component) {
  _inheritsLoose(SearchInner2, _Component);
  function SearchInner2() {
    var _this;
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    ...
    _this.renderNoResults = function() {
      ...
      return import_react127.default.createElement("div", {
        ...
        className: "header"
      }, noResultsMessage), noResultsDescription && import_react127.default.createElement("div", {
        className: "description"
    ...
    _this.renderResult = function(_ref2, index, _array, offset2) {
      ...
      return import_react127.default.createElement(SearchResult_default, _extends({
    ...
    _this.renderCategories = function() {
      ...
      return map_default(categories, function(_ref3) {
        ...
        return import_react127.default.createElement(SearchCategory_default, categoryProps, category.results.map(renderFn));
      });
    };
    ...
    _this.renderResultsMenu = function() {
      ...
      return import_react127.default.createElement(SearchResults_default, {
        className: resultsClasses
      }, menuContent);
    };
    return _this;
  }
  SearchInner2.getAutoControlledStateFromProps = function getAutoControlledStateFromProps(props, state) {
  ...
  var _proto = SearchInner2.prototype;
  _proto.shouldComponentUpdate = function shouldComponentUpdate(nextProps, nextState) {
  ...
  _proto.render = function render() {
    ...
    var _this$props6 = this.props, aligned = _this$props6.aligned, category = _this$props6.category, className = _this$props6.className, innerRef = _this$props6.innerRef, fluid = _this$props6.fluid, loading = _this$props6.loading, size2 = _this$props6.size;
    ...
    var unhandled = getUnhandledProps_default(Search, this.props);
    var ElementType = getElementType_default(Search, this.props);
    var _partitionHTMLProps = partitionHTMLProps(unhandled, {
      htmlProps: htmlInputAttrs
    }), htmlInputProps2 = _partitionHTMLProps[0], rest = _partitionHTMLProps[1];
...
Search.propTypes = true ? {
  ...
  /** Initial value. */
  defaultValue: import_prop_types119.default.string,
  /** Shorthand for Icon. */
  icon: import_prop_types119.default.oneOfType([import_prop_types119.default.node, import_prop_types119.default.object]),
  /** Minimum characters to query for results */
  minCharacters: import_prop_types119.default.number,
  /** Additional text for "No Results" message with less emphasis. */
  noResultsDescription: import_prop_types119.default.node,
  /** Message to display when there are no results. */
  noResultsMessage: import_prop_types119.default.node,
   ...
   */
  results: import_prop_types119.default.oneOfType([import_prop_types119.default.arrayOf(import_prop_types119.default.shape(SearchResult_default.propTypes)), import_prop_types119.default.shape(SearchCategory_default.propTypes)]),
  /** Whether the search should automatically select the first result after searching. */
  selectFirstResult: import_prop_types119.default.bool,
  /** Whether a "no results" message should be shown if no results are found. */
  showNoResults: import_prop_types119.default.bool,
  /** Current value of the search input. Creates a controlled component. */
  value: import_prop_types119.default.string,
  // ------------------------------------
  // Rendering
  // ------------------------------------
  /**
   ...
   */
  categoryLayoutRenderer: import_prop_types119.default.func,
  /**
   ...
   */
  categoryRenderer: import_prop_types119.default.func,
  /**
   ...
   */
  resultRenderer: import_prop_types119.default.func,
  // ------------------------------------
  // Callbacks
  // ------------------------------------
  /**
   ...
   * @param {object} data - All props.
   */
  onMouseDown: import_prop_types119.default.func,
  /**
   ...
   * @param {object} data - All props.
   */
  onResultSelect: import_prop_types119.default.func,
  /**
   * Called on search input change.
   *
   * @param {SyntheticEvent} event - React's original SyntheticEvent.
   ...
   */
  onSearchChange: import_prop_types119.default.func,
  /**
   ...
   * @param {object} data - All props.
   */
  onSelectionChange: import_prop_types119.default.func,
  // ------------------------------------
  // Style
  // ------------------------------------
  /** A search can have its results aligned to its left or right container edge. */
  aligned: import_prop_types119.default.string,
  /** A search can display results from remote content ordered by categories. */
  category: import_prop_types119.default.bool,
  /** Additional classes. */
  className: import_prop_types119.default.string,
  /** A search can have its results take up the width of its container. */
  fluid: import_prop_types119.default.bool,
  /** Shorthand for input element. */
  input: customPropTypes_exports.itemShorthand,
  /** A search can show a loading indicator. */
  loading: import_prop_types119.default.bool,
  /** A search can have different sizes. */
  size: import_prop_types119.default.oneOf(without_default(SUI_exports.SIZES, "medium")),
  /** A search can show placeholder text when empty. */
  placeholder: import_prop_types119.default.string
} : {};
Search.defaultProps = {
  icon: "search",
  input: "text",
...
if (true) {
  ...
  SearchInner.propTypes = true ? Search.propTypes : {};
}
Search.Category = SearchCategory_default;
Search.CategoryLayout = SearchCategoryLayout_default;
Search.Result = SearchResult_default;
...
var useEventListener = function useEventListener2(options) {
  ...
  var latestListener = React139.useRef(listener);
  latestListener.current = listener;
  var eventHandler = React139.useCallback(function(event) {
    return latestListener.current(event);
  }, []);
  var timeoutId = React139.useRef(void 0);
  if (true) {
...
var SidebarPushable = import_react128.default.forwardRef(function(props, ref2) {
...
var SidebarPusher = import_react129.default.forwardRef(function(props, ref2) {
...
SidebarPusher.propTypes = true ? {
  ...
  content: customPropTypes_exports.contentShorthand,
  /** Controls whether or not the dim is displayed. */
  dimmed: import_prop_types121.default.bool
} : {};
var SidebarPusher_default = SidebarPusher;

// node_modules/semantic-ui-react/dist/es/modules/Sidebar/Sidebar.js
function useAnimationTick(visible) {
  var previousVisible = usePrevious_default(visible);
  var tickIncrement = !!visible === !!previousVisible ? 0 : 1;
  var animationTick = import_react130.default.useRef(0);
  var forceUpdate = useForceUpdate();
  var currentTick = animationTick.current + tickIncrement;
  var resetAnimationTick = import_react130.default.useCallback(function() {
    animationTick.current = 0;
    forceUpdate();
  }, []);
  import_react130.default.useEffect(function() {
    animationTick.current = currentTick;
  });
  return [currentTick, resetAnimationTick];
}
var Sidebar = import_react130.default.forwardRef(function(props, ref2) {
  var animation = props.animation, className = props.className, children = props.children, content = props.content, direction = props.direction, target = props.target, visible = props.visible, width = props.width;
  var _useAnimationTick = useAnimationTick(visible), animationTick = _useAnimationTick[0], resetAnimationTick = _useAnimationTick[1];
  var elementRef = useMergedRefs(ref2, import_react130.default.useRef());
  var animationTimer = import_react130.default.useRef();
  var skipNextCallback = import_react130.default.useRef();
  var handleAnimationEnd = useEventCallback(function() {
    var callback = visible ? "onShow" : "onHidden";
    resetAnimationTick();
    invoke_default(props, callback, null, props);
  });
  ...
  var handleDocumentClick = function handleDocumentClick2(e) {
    if (!doesNodeContainClick_default(elementRef.current, e)) {
      skipNextCallback.current = true;
      invoke_default(props, "onHide", e, _extends({}, props, {
        visible: false
      }));
    }
  };
  ...
  var rest = getUnhandledProps_default(Sidebar, props);
  var ElementType = getElementType_default(Sidebar, props);
  var targetProp = isRefObject(target) ? {
    targetRef: target
  } : {
    target
  };
  return import_react130.default.createElement(import_react130.default.Fragment, null, import_react130.default.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: elementRef
  }), childrenUtils_exports.isNil(children) ? content : children), visible && import_react130.default.createElement(EventListener, _extends({
...
Sidebar.propTypes = true ? {
  ...
  /** Animation style. */
  animation: import_prop_types122.default.oneOf(["overlay", "push", "scale down", "uncover", "slide out", "slide along"]),
  /** Primary content. */
  ...
  direction: import_prop_types122.default.oneOf(["top", "right", "bottom", "left"]),
  /**
   ...
   * @param {object} data - All props.
   */
  onHidden: import_prop_types122.default.func,
  /**
   ...
   * @param {object} data - All props.
   */
  onVisible: import_prop_types122.default.func,
  /** A sidebar can handle clicks on the passed element. */
  target: import_prop_types122.default.oneOfType([customPropTypes_exports.domNode, customPropTypes_exports.refObject]),
  /** Controls whether or not the sidebar is visible on the page. */
  visible: import_prop_types122.default.bool,
  /** Sidebar width. */
  width: import_prop_types122.default.oneOf(["very thin", "thin", "wide", "very wide"])
} : {};
...
var Sticky = import_react131.default.forwardRef(function(props, ref2) {
  var _stickyRect$current;
  var active = props.active, bottomOffset = props.bottomOffset, children = props.children, className = props.className, context = props.context, offset2 = props.offset, scrollContext = props.scrollContext, styleElement = props.styleElement;
  var _React$useState = import_react131.default.useState(false), sticky = _React$useState[0], setSticky = _React$useState[1];
  var _React$useState2 = import_react131.default.useState(), bound = _React$useState2[0], setBound = _React$useState2[1];
  var _React$useState3 = import_react131.default.useState(), bottom2 = _React$useState3[0], setBottom = _React$useState3[1];
  var _React$useState4 = import_react131.default.useState(), pushing = _React$useState4[0], setPushing = _React$useState4[1];
  var _React$useState5 = import_react131.default.useState(), top2 = _React$useState5[0], setTop = _React$useState5[1];
  var stickyRef = import_react131.default.useRef();
  var triggerRef = import_react131.default.useRef();
  var triggerRect = import_react131.default.useRef();
  var contextRect = import_react131.default.useRef();
  var stickyRect = import_react131.default.useRef();
  var frameId = import_react131.default.useRef();
  var ticking = import_react131.default.useRef();
  var assignRects = function assignRects2() {
  ...
  var didReachContextBottom = function didReachContextBottom2() {
    return stickyRect.current.height + offset2 >= contextRect.current.bottom;
  };
  var didReachStartingPoint = function didReachStartingPoint2() {
    return stickyRect.current.top <= triggerRect.current.top;
  };
  var didTouchScreenTop = function didTouchScreenTop2() {
    return triggerRect.current.top < offset2;
  };
  var didTouchScreenBottom = function didTouchScreenBottom2() {
    return contextRect.current.bottom + bottomOffset > window.innerHeight;
  };
  var isOversized = function isOversized2() {
    return stickyRect.current.height > window.innerHeight;
  };
  var togglePushing = function togglePushing2(value) {
    if (props.pushing) {
      setPushing(value);
    }
  };
  var setSticked = function setSticked2(e, newBound) {
    setBound(newBound);
    setSticky(true);
    invoke_default(props, "onStick", e, props);
  };
  var setUnsticked = function setUnsticked2(e, newBound) {
    setBound(newBound);
    setSticky(false);
    invoke_default(props, "onUnstick", e, props);
  };
  var stickToContextBottom = function stickToContextBottom2(e) {
    setSticked(e, true);
    togglePushing(true);
    invoke_default(props, "onBottom", e, props);
  };
  var stickToContextTop = function stickToContextTop2(e) {
    setUnsticked(e, false);
    togglePushing(false);
    invoke_default(props, "onTop", e, props);
  };
  var stickToScreenBottom = function stickToScreenBottom2(e) {
    setSticked(e, false);
    setBottom(bottomOffset);
    setTop(null);
  };
  var stickToScreenTop = function stickToScreenTop2(e) {
    setSticked(e, false);
    setBottom(null);
    setTop(offset2);
  };
  var update = function update2(e) {
  ...
  import_react131.default.useEffect(function() {
    return function() {
  ...
  var rest = getUnhandledProps_default(Sticky, props);
  var ElementType = getElementType_default(Sticky, props);
  ...
  return import_react131.default.createElement(ElementType, _extends({}, rest, {
    className: containerClasses,
    ref: ref2
...
Sticky.propTypes = true ? {
  ...
  bottomOffset: import_prop_types123.default.number,
  /** Primary content. */
  children: import_prop_types123.default.node,
  /** Additional classes. */
  className: import_prop_types123.default.string,
  /** Context which sticky element should stick to. */
  context: import_prop_types123.default.oneOfType([customPropTypes_exports.domNode, customPropTypes_exports.refObject]),
  /** Offset in pixels from the top of the screen when fixing element to viewport. */
  offset: import_prop_types123.default.number,
  /**
   ...
   * @param {object} data - All props.
   */
  onBottom: import_prop_types123.default.func,
  /**
   ...
   * @param {object} data - All props.
   */
  onStick: import_prop_types123.default.func,
  /**
   ...
   * @param {object} data - All props.
   */
  onTop: import_prop_types123.default.func,
  /**
   ...
   * @param {object} data - All props.
   */
  onUnstick: import_prop_types123.default.func,
  /** Whether element should be "pushed" by the viewport, attaching to the bottom of the screen when scrolling up. */
  pushing: import_prop_types123.default.bool,
  /** Context which sticky should attach onscroll events. */
  scrollContext: import_prop_types123.default.oneOfType([customPropTypes_exports.domNode, customPropTypes_exports.refObject]),
  /** Custom style for sticky element. */
  styleElement: import_prop_types123.default.object
} : {};
Sticky.defaultProps = {
  active: true,
  bottomOffset: 0,
...
var TabPane = import_react132.default.forwardRef(function(props, ref2) {
  ...
  return import_react132.default.createElement(ElementType, _extends({}, calculatedDefaultProps, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
// node_modules/semantic-ui-react/dist/es/modules/Tab/Tab.js
var Tab = import_react133.default.forwardRef(function(props, ref2) {
  var grid = props.grid, menu = props.menu, panes = props.panes, menuPosition = props.menuPosition, renderActiveOnly = props.renderActiveOnly;
  var _useAutoControlledVal = useAutoControlledValue_default({
    state: props.activeIndex,
    defaultState: props.defaultActiveIndex,
    initialState: 0
  ...
  var handleItemClick = function handleItemClick2(e, _ref) {
    var index = _ref.index;
    invoke_default(props, "onTabChange", e, _extends({}, props, {
      activeIndex: index
    }));
  ...
  var renderItems = function renderItems2() {
    if (renderActiveOnly) {
      return invoke_default(get_default(panes, "[" + activeIndex + "]"), "render", props);
    }
  ...
  var renderMenu = function renderMenu2() {
  ...
  var renderVertical = function renderVertical2(menuElement2) {
    var paneWidth = grid.paneWidth, tabWidth = grid.tabWidth, gridProps = _objectWithoutPropertiesLoose(grid, ["paneWidth", "tabWidth"]);
    var position = menuPosition || menuElement2.props.tabular === "right" && "right" || "left";
    return import_react133.default.createElement(Grid_default, gridProps, position === "left" && GridColumn_default.create({
      width: tabWidth,
  ...
  var rest = getUnhandledProps_default(Tab, props);
  var ElementType = getElementType_default(Tab, props);
  if (menuElement.props.vertical) {
    return import_react133.default.createElement(ElementType, _extends({}, rest, {
      ref: ref2
...
Tab.propTypes = true ? {
  ...
  defaultActiveIndex: import_prop_types125.default.oneOfType([import_prop_types125.default.number, import_prop_types125.default.string]),
  /** Index of the currently active tab. */
  activeIndex: import_prop_types125.default.oneOfType([import_prop_types125.default.number, import_prop_types125.default.string]),
  /**
   * Shorthand props for the Menu.
   * tabular, if true, will derive final value from `menuPosition`, otherwise set 'left' or 'right' explicitly.
   */
  menu: import_prop_types125.default.object,
  /** Align vertical menu */
  menuPosition: import_prop_types125.default.oneOf(["left", "right"]),
  /** Shorthand props for the Grid. Only applicable to vertical menus. */
  grid: import_prop_types125.default.object,
  /**
   ...
   */
  onTabChange: import_prop_types125.default.func,
  /**
   ...
   */
  panes: import_prop_types125.default.arrayOf(import_prop_types125.default.shape({
    menuItem: customPropTypes_exports.itemShorthand,
    pane: customPropTypes_exports.itemShorthand,
    render: import_prop_types125.default.func
  })),
  /** A Tab can render only active pane. */
  renderActiveOnly: import_prop_types125.default.bool
} : {};
...
var Advertisement = import_react134.default.forwardRef(function(props, ref2) {
  ...
  return import_react134.default.createElement(ElementType, _extends({}, rest, {
    className: classes,
    "data-text": test,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
...
Advertisement.propTypes = true ? {
  ...
  centered: import_prop_types126.default.bool,
  /** Primary content. */
  ...
  test: import_prop_types126.default.oneOfType([import_prop_types126.default.bool, import_prop_types126.default.number, import_prop_types126.default.string]),
  /** Varies the size of the advertisement. */
  unit: import_prop_types126.default.oneOf(["medium rectangle", "large rectangle", "vertical rectangle", "small rectangle", "mobile banner", "banner", "vertical banner", "top banner", "half banner", "button", "square button", "small button", "skyscraper", "wide skyscraper", "leaderboard", "large leaderboard", "mobile leaderboard", "billboard", "panorama", "netboard", "half page", "square", "small square"]).isRequired
} : {};
...
var CardDescription = import_react135.default.forwardRef(function(props, ref2) {
...
CardDescription.propTypes = true ? {
  ...
  textAlign: import_prop_types127.default.oneOf(without_default(SUI_exports.TEXT_ALIGNMENTS, "justified"))
} : {};
...
var CardHeader = import_react136.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content, textAlign = props.textAlign;
...
var CardMeta = import_react137.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content, textAlign = props.textAlign;
...
// node_modules/semantic-ui-react/dist/es/views/Card/CardContent.js
var CardContent = import_react138.default.forwardRef(function(props, ref2) {
...
CardContent.propTypes = true ? {
  ...
  extra: import_prop_types130.default.bool,
...
var CardGroup = import_react139.default.forwardRef(function(props, ref2) {
  ...
  var itemsJSX = map_default(items, function(item) {
    ...
    return import_react139.default.createElement(Card_default, _extends({
      key
    }, item));
  });
  return import_react139.default.createElement(ElementType, _extends({}, rest, {
...
CardGroup.propTypes = true ? {
  ...
  doubling: import_prop_types131.default.bool,
  /** Shorthand array of props for Card. */
  items: customPropTypes_exports.collectionShorthand,
  /** A group of cards can set how many cards should exist in a row. */
  itemsPerRow: import_prop_types131.default.oneOf(SUI_exports.WIDTHS),
  /** A group of cards can automatically stack rows to a single columns on mobile devices. */
  stackable: import_prop_types131.default.bool,
...
// node_modules/semantic-ui-react/dist/es/views/Card/Card.js
var Card = import_react140.default.forwardRef(function(props, ref2) {
  var centered = props.centered, children = props.children, className = props.className, color = props.color, content = props.content, description = props.description, extra = props.extra, fluid = props.fluid, header = props.header, href = props.href, image = props.image, link = props.link, meta = props.meta, onClick = props.onClick, raised = props.raised;
  ...
  var rest = getUnhandledProps_default(Card, props);
  var ElementType = getElementType_default(Card, props, function() {
    if (onClick) {
      return "a";
    }
  });
  ...
  }), (description || header || meta) && import_react140.default.createElement(CardContent_default, {
    description,
    header,
    meta
  }), extra && import_react140.default.createElement(CardContent_default, {
    extra: true
  }, extra));
});
...
Card.propTypes = true ? {
  ...
  color: import_prop_types132.default.oneOf(SUI_exports.COLORS),
  /** Shorthand for primary content. */
  content: customPropTypes_exports.contentShorthand,
  /** Shorthand for CardDescription. */
  description: customPropTypes_exports.itemShorthand,
  ...
  fluid: import_prop_types132.default.bool,
  /** Shorthand for CardHeader. */
  header: customPropTypes_exports.itemShorthand,
  /** Render as an `a` tag instead of a `div` and adds the href attribute. */
  ...
  link: import_prop_types132.default.bool,
  /** Shorthand for CardMeta. */
  meta: customPropTypes_exports.itemShorthand,
  /**
   ...
   * @param {object} data - All props.
   */
  onClick: import_prop_types132.default.func,
  /** A Card can be formatted to raise above the page. */
  raised: import_prop_types132.default.bool
} : {};
...
var CommentAction = import_react141.default.forwardRef(function(props, ref2) {
...
var CommentActions = import_react142.default.forwardRef(function(props, ref2) {
  var className = props.className, children = props.children, content = props.content;
  var classes = clsx_m_default("actions", className);
...
var CommentAuthor = import_react143.default.forwardRef(function(props, ref2) {
  var className = props.className, children = props.children, content = props.content;
...
var CommentAvatar = import_react144.default.forwardRef(function(props, ref2) {
  ...
  return import_react144.default.createElement(ElementType, _extends({}, rootProps, {
    className: classes,
    ref: ref2
  }), createHTMLImage(src, {
    autoGenerateKey: false,
...
CommentAvatar.propTypes = true ? {
  ...
  src: import_prop_types136.default.string
} : {};
...
var CommentContent = import_react145.default.forwardRef(function(props, ref2) {
  var className = props.className, children = props.children, content = props.content;
  ...
  return import_react145.default.createElement(ElementType, _extends({}, rest, {
    className: classes,
    ref: ref2
  }), childrenUtils_exports.isNil(children) ? content : children);
});
...
var CommentGroup = import_react146.default.forwardRef(function(props, ref2) {
...
CommentGroup.propTypes = true ? {
  ...
  collapsed: import_prop_types138.default.bool,
  /** Shorthand for primary content. */
  content: customPropTypes_exports.contentShorthand,
  /** Comments can hide extra information unless a user shows intent to interact with a comment. */
  minimal: import_prop_types138.default.bool,
  /** Comments can have different sizes. */
  size: import_prop_types138.default.oneOf(without_default(SUI_exports.SIZES, "medium")),
  /** A comment list can be threaded to showing the relationship between conversations. */
  threaded: import_prop_types138.default.bool
} : {};
...
var CommentMetadata = import_react147.default.forwardRef(function(props, ref2) {
  var className = props.className, children = props.children, content = props.content;
...
var CommentText = import_react148.default.forwardRef(function(props, ref2) {
  var className = props.className, children = props.children, content = props.content;
...
// node_modules/semantic-ui-react/dist/es/views/Comment/Comment.js
var Comment = import_react149.default.forwardRef(function(props, ref2) {
...
Comment.propTypes = true ? {
  ...
  collapsed: import_prop_types141.default.bool,
  /** Shorthand for primary content. */
  content: customPropTypes_exports.contentShorthand
} : {};
...
var FeedDate = import_react150.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
...
var FeedExtra = import_react151.default.forwardRef(function(props, ref2) {
...
FeedExtra.propTypes = true ? {
  ...
  images: customPropTypes_exports.every([customPropTypes_exports.disallow(["text"]), import_prop_types143.default.oneOfType([import_prop_types143.default.bool, customPropTypes_exports.collectionShorthand])]),
  /** An event can contain additional text information. */
  text: import_prop_types143.default.bool
} : {};
...
var FeedLike = import_react152.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content, icon = props.icon;
...
// node_modules/semantic-ui-react/dist/es/views/Feed/FeedMeta.js
var FeedMeta = import_react153.default.forwardRef(function(props, ref2) {
...
var FeedUser = import_react154.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
...
// node_modules/semantic-ui-react/dist/es/views/Feed/FeedSummary.js
var FeedSummary = import_react155.default.forwardRef(function(props, ref2) {
...
// node_modules/semantic-ui-react/dist/es/views/Feed/FeedContent.js
var FeedContent = import_react156.default.forwardRef(function(props, ref2) {
...
var FeedLabel = import_react157.default.forwardRef(function(props, ref2) {
...
// node_modules/semantic-ui-react/dist/es/views/Feed/FeedEvent.js
var FeedEvent = import_react158.default.forwardRef(function(props, ref2) {
  ...
  return import_react158.default.createElement(ElementType, _extends({}, rest, {
    ...
    autoGenerateKey: false
  }), hasContentProp && import_react158.default.createElement(FeedContent_default, contentProps), children);
});
...
// node_modules/semantic-ui-react/dist/es/views/Feed/Feed.js
var Feed = import_react159.default.forwardRef(function(props, ref2) {
  ...
  var eventElements = map_default(events, function(eventProps) {
    ...
    return import_react159.default.createElement(FeedEvent_default, _extends({
      date,
      key: finalKey,
      meta,
      summary
...
Feed.propTypes = true ? {
  ...
  size: import_prop_types151.default.oneOf(without_default(SUI_exports.SIZES, "mini", "tiny", "medium", "big", "huge", "massive"))
} : {};
...
var ItemHeader = import_react160.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("header", className);
...
var ItemDescription = import_react161.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("description", className);
...
var ItemExtra = import_react162.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
...
var ItemMeta = import_react163.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("meta", className);
...
// node_modules/semantic-ui-react/dist/es/views/Item/ItemContent.js
var ItemContent = import_react164.default.forwardRef(function(props, ref2) {
...
ItemContent.propTypes = true ? {
  ...
  verticalAlign: import_prop_types156.default.oneOf(SUI_exports.VERTICAL_ALIGNMENTS)
} : {};
...
var ItemGroup = import_react165.default.forwardRef(function(props, ref2) {
  ...
  var itemsJSX = map_default(items, function(item) {
    ...
    return import_react165.default.createElement(Item_default, _extends({}, itemProps, {
      key: finalKey
    }));
  });
  return import_react165.default.createElement(ElementType, _extends({}, rest, {
...
ItemGroup.propTypes = true ? {
  ...
  divided: import_prop_types157.default.bool,
  /** Shorthand array of props for Item. */
  items: customPropTypes_exports.collectionShorthand,
  /** An item can be formatted so that the entire contents link to another page. */
  link: import_prop_types157.default.bool,
  /** A group of items can relax its padding to provide more negative space. */
  relaxed: import_prop_types157.default.oneOfType([import_prop_types157.default.bool, import_prop_types157.default.oneOf(["very"])]),
  /** Prevent items from stacking on mobile. */
  unstackable: import_prop_types157.default.bool
} : {};
var ItemGroup_default = ItemGroup;

// node_modules/semantic-ui-react/dist/es/views/Item/ItemImage.js
var import_react166 = __toESM(require_react());
var ItemImage = import_react166.default.forwardRef(function(props, ref2) {
  var size2 = props.size;
  var rest = getUnhandledProps_default(ItemImage, props);
  return import_react166.default.createElement(Image_default, _extends({}, rest, {
    size: size2,
    ui: !!size2,
    wrapped: true,
    ref: ref2
...
// node_modules/semantic-ui-react/dist/es/views/Item/Item.js
var Item = import_react167.default.forwardRef(function(props, ref2) {
  ...
  if (!childrenUtils_exports.isNil(children)) {
    return import_react167.default.createElement(ElementType, _extends({}, rest, {
      className: classes,
      ref: ref2
    }), children);
  }
  return import_react167.default.createElement(ElementType, _extends({}, rest, {
    ...
    autoGenerateKey: false
  }), import_react167.default.createElement(ItemContent_default, {
    content,
    description,
    extra,
    header,
...
var StatisticGroup = import_react168.default.forwardRef(function(props, ref2) {
...
StatisticGroup.propTypes = true ? {
  ...
  color: import_prop_types159.default.oneOf(SUI_exports.COLORS),
  /** Shorthand for primary content. */
  content: customPropTypes_exports.contentShorthand,
  /** A statistic group can present its measurement horizontally. */
  horizontal: import_prop_types159.default.bool,
  /** A statistic group can be formatted to fit on a dark background. */
  inverted: import_prop_types159.default.bool,
  /** Array of props for Statistic. */
  items: customPropTypes_exports.collectionShorthand,
  /** A statistic group can vary in size. */
  size: import_prop_types159.default.oneOf(without_default(SUI_exports.SIZES, "big", "massive", "medium")),
  /** A statistic group can have its items divided evenly. */
  widths: import_prop_types159.default.oneOf(SUI_exports.WIDTHS)
} : {};
...
var StatisticLabel = import_react169.default.forwardRef(function(props, ref2) {
  var children = props.children, className = props.className, content = props.content;
  var classes = clsx_m_default("label", className);
...
var StatisticValue = import_react170.default.forwardRef(function(props, ref2) {
...
StatisticValue.propTypes = true ? {
  ...
  text: import_prop_types161.default.bool
} : {};
...
// node_modules/semantic-ui-react/dist/es/views/Statistic/Statistic.js
var Statistic = import_react171.default.forwardRef(function(props, ref2) {
...
Statistic.propTypes = true ? {
  ...
  color: import_prop_types162.default.oneOf(SUI_exports.COLORS),
  /** Shorthand for primary content. */
  content: customPropTypes_exports.contentShorthand,
  /** A statistic can sit to the left or right of other content. */
  floated: import_prop_types162.default.oneOf(SUI_exports.FLOATS),
  /** A statistic can present its measurement horizontally. */
  horizontal: import_prop_types162.default.bool,
  /** A statistic can be formatted to fit on a dark background. */
  inverted: import_prop_types162.default.bool,
  /** Label content of the Statistic. */
  label: customPropTypes_exports.contentShorthand,
  /** A statistic can vary in size. */
  size: import_prop_types162.default.oneOf(without_default(SUI_exports.SIZES, "big", "massive", "medium")),
...
export {
  ...
  DimmerInner_default as DimmerInner,
  ...
  ModalActions_default as ModalActions,
  ...
  PopupContent_default as PopupContent,
  PopupHeader_default as PopupHeader,
  ...
  RatingIcon_default as RatingIcon,
  Reveal_default as Reveal,
  RevealContent_default as RevealContent,
  Search_default as Search,
  SearchCategory_default as SearchCategory,
  SearchCategoryLayout_default as SearchCategoryLayout,
  SearchResult_default as SearchResult,
  ...
  TransitionablePortal_default as TransitionablePortal
};
