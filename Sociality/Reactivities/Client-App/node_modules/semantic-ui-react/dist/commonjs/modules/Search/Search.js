...
var Search = /*#__PURE__*/_react.default.forwardRef(function (props, ref) {
  return /*#__PURE__*/_react.default.createElement(SearchInner, (0, _extends2.default)({}, props, {
    innerRef: ref
  }));
});
...
var SearchInner = /*#__PURE__*/function (_Component) {
  (0, _inheritsLoose2.default)(SearchInner, _Component);
  ...
  SearchInner.getAutoControlledStateFromProps = function getAutoControlledStateFromProps(props, state) {
  ...
  var _proto = SearchInner.prototype;
...
if (process.env.NODE_ENV !== 'production') {
  ...
  SearchInner.propTypes = process.env.NODE_ENV !== "production" ? Search.propTypes : {};
}

Search.Category = _SearchCategory.default;
Search.CategoryLayout = _SearchCategoryLayout.default;
