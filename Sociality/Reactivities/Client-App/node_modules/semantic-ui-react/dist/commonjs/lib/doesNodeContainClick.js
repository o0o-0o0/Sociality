...
var doesNodeContainClick = function doesNodeContainClick(node, e) {
  if ((0, _some2.default)([e, node], _isNil2.default)) {
    return false;
  ...
  if ((0, _some2.default)([clientX, clientY], _isNil2.default)) {
    return false;
  }
  ...
  if ((0, _some2.default)([top, bottom, left, right], _isNil2.default)) {
    return false;
